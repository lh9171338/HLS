...
entity calcOrientationHi6jw_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of calcOrientationHi6jw_rom is 
...
entity calcOrientationHi6jw is
    generic (
...
architecture arch of calcOrientationHi6jw is
    component calcOrientationHi6jw_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    calcOrientationHi6jw_rom_U :  component calcOrientationHi6jw_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

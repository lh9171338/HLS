...
#ifndef _Haaris_Core_entry242_HH_
#define _Haaris_Core_entry242_HH_
...
struct Haaris_Core_entry242 : public sc_module {
    ...
    // Module declarations
    Haaris_Core_entry242(sc_module_name name);
    SC_HAS_PROCESS(Haaris_Core_entry242);

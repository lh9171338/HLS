...
#ifndef __SIFT2_Core_mac_mubFp__HH__
#define __SIFT2_Core_mac_mubFp__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(SIFT2_Core_mac_mubFp) {
    ...
    SC_CTOR(SIFT2_Core_mac_mubFp):  simcore_mac_1_U ("simcore_mac_1_U") {

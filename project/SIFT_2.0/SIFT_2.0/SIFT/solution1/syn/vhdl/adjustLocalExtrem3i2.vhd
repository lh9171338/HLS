...
entity adjustLocalExtrem3i2_rom is 
    generic(
             DWIDTH     : integer := 24; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of adjustLocalExtrem3i2_rom is 
...
entity adjustLocalExtrem3i2 is
    generic (
...
architecture arch of adjustLocalExtrem3i2 is
    component adjustLocalExtrem3i2_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    adjustLocalExtrem3i2_rom_U :  component adjustLocalExtrem3i2_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

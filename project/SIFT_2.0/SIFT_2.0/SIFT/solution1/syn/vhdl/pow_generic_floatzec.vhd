...
entity pow_generic_floatzec_rom is 
    generic(
             DWIDTH     : integer := 56; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of pow_generic_floatzec_rom is 
...
entity pow_generic_floatzec is
    generic (
...
architecture arch of pow_generic_floatzec is
    component pow_generic_floatzec_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pow_generic_floatzec_rom_U :  component pow_generic_floatzec_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

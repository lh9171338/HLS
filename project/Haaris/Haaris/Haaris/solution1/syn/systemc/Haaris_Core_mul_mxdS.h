...
#ifndef __Haaris_Core_mul_mxdS__HH__
#define __Haaris_Core_mul_mxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mul_mxdS) {
    ...
    SC_CTOR(Haaris_Core_mul_mxdS):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {

...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename arr_val \
    op interface \
    ports { arr_val_address0 { O 11 vector } arr_val_ce0 { O 1 bit } arr_val_q0 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { mat_rows_V_din { O 6 vector } mat_rows_V_full_n { I 1 bit } mat_rows_V_write { O 1 bit } } \
} "
}

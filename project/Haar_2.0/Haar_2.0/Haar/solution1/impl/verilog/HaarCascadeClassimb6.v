...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module HaarCascadeClassimb6_rom (
...
initial begin
    $readmemh("./HaarCascadeClassimb6_rom.dat", ram0);
    $readmemh("./HaarCascadeClassimb6_rom.dat", ram1);
    $readmemh("./HaarCascadeClassimb6_rom.dat", ram2);
end
...
HaarCascadeClassimb6_rom HaarCascadeClassimb6_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

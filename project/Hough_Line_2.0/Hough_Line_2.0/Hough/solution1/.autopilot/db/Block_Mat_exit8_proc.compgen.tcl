...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_lines_rows_out \
    op interface \
    ports { lines_rows_out_din { O 4 vector } lines_rows_out_full_n { I 1 bit } lines_rows_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_lines_cols_out \
    op interface \
    ports { lines_cols_out_din { O 8 vector } lines_cols_out_full_n { I 1 bit } lines_cols_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_lineGap_out \
    op interface \
    ports { lineGap_out_din { O 32 vector } lineGap_out_full_n { I 1 bit } lineGap_out_write { O 1 bit } } \
} "
}

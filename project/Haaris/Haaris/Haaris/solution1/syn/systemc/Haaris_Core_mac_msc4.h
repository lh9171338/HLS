...
#ifndef __Haaris_Core_mac_msc4__HH__
#define __Haaris_Core_mac_msc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_msc4) {
    ...
    SC_CTOR(Haaris_Core_mac_msc4):  simcore_mac_10_U ("simcore_mac_10_U") {

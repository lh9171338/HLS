...
set C_modelArgList {
	{ mat_rows_V int 6 regular {fifo 0}  }
	{ mat_cols_V int 6 regular {fifo 0}  }
	{ mat_data_stream_V int 8 regular {fifo 0 volatile }  }
	{ arr_val_V int 24 regular {array 784 { 0 3 } 0 1 }  }
	{ arr_rows int 6 regular {fifo 1}  }
	{ arr_cols int 6 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mat_rows_V", "interface" : "fifo", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "mat_cols_V", "interface" : "fifo", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "mat_data_stream_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "arr_val_V", "interface" : "memory", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "arr_rows", "interface" : "fifo", "bitwidth" : 6, "direction" : "WRITEONLY"} , 
 	{ "Name" : "arr_cols", "interface" : "fifo", "bitwidth" : 6, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ arr_val_V_address0 sc_out sc_lv 10 signal 3 } 
	{ arr_val_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ arr_val_V_we0 sc_out sc_logic 1 signal 3 } 
	{ arr_val_V_d0 sc_out sc_lv 24 signal 3 } 
	{ arr_rows_din sc_out sc_lv 6 signal 4 } 
	{ arr_rows_full_n sc_in sc_logic 1 signal 4 } 
	{ arr_rows_write sc_out sc_logic 1 signal 4 } 
	{ arr_cols_din sc_out sc_lv 6 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mat_rows_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "mat_rows_V", "role": "dout" }} , 
 	...
 	{ "name": "mat_cols_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "mat_cols_V", "role": "dout" }} , 
 	...
 	{ "name": "arr_val_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "arr_val_V", "role": "address0" }} , 
 	{ "name": "arr_val_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "arr_val_V", "role": "ce0" }} , 
 	{ "name": "arr_val_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "arr_val_V", "role": "we0" }} , 
 	{ "name": "arr_val_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "arr_val_V", "role": "d0" }} , 
 	{ "name": "arr_rows_din", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "arr_rows", "role": "din" }} , 
 	...
 	{ "name": "arr_cols_din", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "arr_cols", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "mat_data_stream_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "mat_data_stream_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "arr_val_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "869"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "869"}
]}
...
set Spec2ImplPortList { 
	mat_rows_V { ap_fifo {  { mat_rows_V_dout fifo_data 0 6 }  { mat_rows_V_empty_n fifo_status 0 1 }  { mat_rows_V_read fifo_update 1 1 } } }
	mat_cols_V { ap_fifo {  { mat_cols_V_dout fifo_data 0 6 }  { mat_cols_V_empty_n fifo_status 0 1 }  { mat_cols_V_read fifo_update 1 1 } } }
	...
	arr_val_V { ap_memory {  { arr_val_V_address0 mem_address 1 10 }  { arr_val_V_ce0 mem_ce 1 1 }  { arr_val_V_we0 mem_we 1 1 }  { arr_val_V_d0 mem_din 1 24 } } }
	arr_rows { ap_fifo {  { arr_rows_din fifo_data 1 6 }  { arr_rows_full_n fifo_status 0 1 }  { arr_rows_write fifo_update 1 1 } } }
	arr_cols { ap_fifo {  { arr_cols_din fifo_data 1 6 }  { arr_cols_full_n fifo_status 0 1 }  { arr_cols_write fifo_update 1 1 } } }
}

...
entity adjustLocalExtrem2iS_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of adjustLocalExtrem2iS_rom is 
...
entity adjustLocalExtrem2iS is
    generic (
...
architecture arch of adjustLocalExtrem2iS is
    component adjustLocalExtrem2iS_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    adjustLocalExtrem2iS_rom_U :  component adjustLocalExtrem2iS_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

...
#ifndef __HoughLines_Core_mhbi__HH__
#define __HoughLines_Core_mhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughLines_Core_mhbi) {
    ...
    SC_CTOR(HoughLines_Core_mhbi):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

...
#ifndef __calcOrientationHi6jw_H__
#define __calcOrientationHi6jw_H__
...
struct calcOrientationHi6jw_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(calcOrientationHi6jw_ram) {
...
SC_MODULE(calcOrientationHi6jw) {
...
calcOrientationHi6jw_ram* meminst;


SC_CTOR(calcOrientationHi6jw) {
meminst = new calcOrientationHi6jw_ram("calcOrientationHi6jw_ram");

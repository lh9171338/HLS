...
#ifndef __SIFT2_Core_mul_mubpm__HH__
#define __SIFT2_Core_mul_mubpm__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(SIFT2_Core_mul_mubpm) {
    ...
    SC_CTOR(SIFT2_Core_mul_mubpm):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

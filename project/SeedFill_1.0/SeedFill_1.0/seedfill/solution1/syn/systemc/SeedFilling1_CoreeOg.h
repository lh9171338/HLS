...
#ifndef _SeedFilling1_CoreeOg_H_
#define _SeedFilling1_CoreeOg_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "SeedFilling1_CoreeOg_memcore.h"

SC_MODULE(SeedFilling1_CoreeOg) {
...
protected:
    ...
    SeedFilling1_CoreeOg_memcore* SeedFilling1_CoreeOg_memcore_U;
...
public:
    ...
    SC_CTOR(SeedFilling1_CoreeOg) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        SeedFilling1_CoreeOg_memcore_U = new SeedFilling1_CoreeOg_memcore("SeedFilling1_CoreeOg_memcore_U");
        SeedFilling1_CoreeOg_memcore_U->clk      ( clk );
        SeedFilling1_CoreeOg_memcore_U->reset    ( reset );
        SeedFilling1_CoreeOg_memcore_U->ce0      ( i_ce0 );
        SeedFilling1_CoreeOg_memcore_U->we0      ( i_we0 );
        SeedFilling1_CoreeOg_memcore_U->address0 ( memcore_iaddr );
        SeedFilling1_CoreeOg_memcore_U->d0       ( i_d0 );
        SeedFilling1_CoreeOg_memcore_U->q0       ( i_q0 );

        SeedFilling1_CoreeOg_memcore_U->ce1      ( t_ce0 );
        SeedFilling1_CoreeOg_memcore_U->we1      ( t_we0 );
        SeedFilling1_CoreeOg_memcore_U->address1 ( memcore_taddr );
        SeedFilling1_CoreeOg_memcore_U->d1       ( t_d0 );
        SeedFilling1_CoreeOg_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "SeedFilling1_CoreeOg.trace");
            // ports

...
#ifndef __SIFT2_Core_uitofpXh4__HH__
#define __SIFT2_Core_uitofpXh4__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(SIFT2_Core_uitofpXh4) {
    ...
    SC_CTOR(SIFT2_Core_uitofpXh4):  ACMP_uitofp_U ("ACMP_uitofp_U") {

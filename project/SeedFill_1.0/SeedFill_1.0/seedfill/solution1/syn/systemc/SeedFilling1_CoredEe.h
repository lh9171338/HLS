...
#ifndef __SeedFilling1_CoredEe__HH__
#define __SeedFilling1_CoredEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(SeedFilling1_CoredEe) {
    ...
    SC_CTOR(SeedFilling1_CoredEe):  ACMP_smul_su_U ("ACMP_smul_su_U") {

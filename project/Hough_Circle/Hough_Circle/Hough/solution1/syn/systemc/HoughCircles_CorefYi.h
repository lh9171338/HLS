...
#ifndef __HoughCircles_CorefYi__HH__
#define __HoughCircles_CorefYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughCircles_CorefYi) {
    ...
    SC_CTOR(HoughCircles_CorefYi):  simcore_mac_0_U ("simcore_mac_0_U") {

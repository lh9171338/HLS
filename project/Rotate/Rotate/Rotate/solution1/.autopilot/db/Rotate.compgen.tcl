...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename src_val \
    op interface \
    ports { src_val_address0 { O 16 vector } src_val_ce0 { O 1 bit } src_val_q0 { I 8 vector } src_val_address1 { O 16 vector } src_val_ce1 { O 1 bit } src_val_q1 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_theta \
    op interface \
    ports { theta_dout { I 32 vector } theta_empty_n { I 1 bit } theta_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dst_rows_out \
    op interface \
    ports { dst_rows_out_din { O 17 vector } dst_rows_out_full_n { I 1 bit } dst_rows_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dst_rows_out1 \
    op interface \
    ports { dst_rows_out1_din { O 17 vector } dst_rows_out1_full_n { I 1 bit } dst_rows_out1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dst_cols_out \
    op interface \
    ports { dst_cols_out_din { O 17 vector } dst_cols_out_full_n { I 1 bit } dst_cols_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_dst_cols_out2 \
    op interface \
    ports { dst_cols_out2_din { O 17 vector } dst_cols_out2_full_n { I 1 bit } dst_cols_out2_write { O 1 bit } } \
} "
}

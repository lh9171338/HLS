...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dst1_data_stream_V_din { O 16 vector } dst1_data_stream_V_full_n { I 1 bit } dst1_data_stream_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dst2_data_stream_V_din { O 16 vector } dst2_data_stream_V_full_n { I 1 bit } dst2_data_stream_V_write { O 1 bit } } \
} "
}

...
void Filter2D_Core_srcvdy::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void Filter2D_Core_srcvdy::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void Filter2D_Core_srcvdy::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void Filter2D_Core_srcvdy::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {

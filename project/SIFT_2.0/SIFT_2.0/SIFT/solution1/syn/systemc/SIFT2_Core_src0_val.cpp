...
void SIFT2_Core_src0_val::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void SIFT2_Core_src0_val::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void SIFT2_Core_src0_val::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void SIFT2_Core_src0_val::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {

...
#ifndef __HoughLines_Core_srcU__HH__
#define __HoughLines_Core_srcU__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughLines_Core_srcU) {
    ...
    SC_CTOR(HoughLines_Core_srcU):  ACMP_sitofp_U ("ACMP_sitofp_U") {

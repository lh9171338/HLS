...
#ifndef __Haaris_Core_mac_mocq__HH__
#define __Haaris_Core_mac_mocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mocq) {
    ...
    SC_CTOR(Haaris_Core_mac_mocq):  simcore_mac_6_U ("simcore_mac_6_U") {

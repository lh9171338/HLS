...
#ifndef __HoughCircles_Coremb6__HH__
#define __HoughCircles_Coremb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughCircles_Coremb6) {
    ...
    SC_CTOR(HoughCircles_Coremb6):  simcore_mac_6_U ("simcore_mac_6_U") {

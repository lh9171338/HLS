...
set ID 55
set hasByteEnable 0
set MemName HoughLinesStandarjbC
...
set ID 56
set hasByteEnable 0
set MemName HoughLinesStandarkbM
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 24
set AddrRange 32
...
set ID 57
set hasByteEnable 0
set MemName HoughLinesStandarlbW
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 180
...
set ID 58
set hasByteEnable 0
set MemName HoughLinesStandarncg
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 204386
set AddrWd 18
set impl_style block
set TrueReset 0
set HasInitializer 0
...
set ID 59
set hasByteEnable 0
set MemName HoughLinesStandarocq
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 204386
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename lines \
    op interface \
    ports { lines_address0 { O 7 vector } lines_ce0 { O 1 bit } lines_we0 { O 1 bit } lines_d0 { O 32 vector } lines_address1 { O 7 vector } lines_ce1 { O 1 bit } lines_we1 { O 1 bit } lines_d1 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lines'"
}
}

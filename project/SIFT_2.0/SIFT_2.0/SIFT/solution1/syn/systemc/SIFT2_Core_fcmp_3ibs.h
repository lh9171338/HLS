...
#ifndef __SIFT2_Core_fcmp_3ibs__HH__
#define __SIFT2_Core_fcmp_3ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(SIFT2_Core_fcmp_3ibs) {
    ...
    SC_CTOR(SIFT2_Core_fcmp_3ibs):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {

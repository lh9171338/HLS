...
#ifndef __FAST2_Core_mac_mucud__HH__
#define __FAST2_Core_mac_mucud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FAST2_Core_mac_mucud) {
    ...
    SC_CTOR(FAST2_Core_mac_mucud):  simcore_mac_1_U ("simcore_mac_1_U") {

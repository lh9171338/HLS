...
#ifndef __Haaris_Core_mul_mbkb__HH__
#define __Haaris_Core_mul_mbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mul_mbkb) {
    ...
    SC_CTOR(Haaris_Core_mul_mbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

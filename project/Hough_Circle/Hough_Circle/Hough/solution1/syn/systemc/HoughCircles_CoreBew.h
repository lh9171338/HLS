...
#ifndef __HoughCircles_CoreBew__HH__
#define __HoughCircles_CoreBew__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughCircles_CoreBew) {
    ...
    SC_CTOR(HoughCircles_CoreBew):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {

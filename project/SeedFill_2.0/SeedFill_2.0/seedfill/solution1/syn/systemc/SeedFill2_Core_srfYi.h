...
#ifndef _SeedFill2_Core_srfYi_H_
#define _SeedFill2_Core_srfYi_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "SeedFill2_Core_srfYi_memcore.h"

SC_MODULE(SeedFill2_Core_srfYi) {
    static const unsigned int DataWidth    = 8;
    static const unsigned int AddressRange = 32;
    static const unsigned int AddressWidth = 18;
...
protected:
    ...
    SeedFill2_Core_srfYi_memcore* SeedFill2_Core_srfYi_memcore_U;
...
public:
    ...
    SC_CTOR(SeedFill2_Core_srfYi) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        SeedFill2_Core_srfYi_memcore_U = new SeedFill2_Core_srfYi_memcore("SeedFill2_Core_srfYi_memcore_U");
        SeedFill2_Core_srfYi_memcore_U->clk      ( clk );
        SeedFill2_Core_srfYi_memcore_U->reset    ( reset );
        SeedFill2_Core_srfYi_memcore_U->ce0      ( i_ce0 );
        SeedFill2_Core_srfYi_memcore_U->we0      ( i_we0 );
        SeedFill2_Core_srfYi_memcore_U->address0 ( memcore_iaddr );
        SeedFill2_Core_srfYi_memcore_U->d0       ( i_d0 );
        SeedFill2_Core_srfYi_memcore_U->q0       ( i_q0 );

        SeedFill2_Core_srfYi_memcore_U->ce1      ( t_ce0 );
        SeedFill2_Core_srfYi_memcore_U->we1      ( t_we0 );
        SeedFill2_Core_srfYi_memcore_U->address1 ( memcore_taddr );
        SeedFill2_Core_srfYi_memcore_U->d1       ( t_d0 );
        SeedFill2_Core_srfYi_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "SeedFill2_Core_srfYi.trace");
            // ports

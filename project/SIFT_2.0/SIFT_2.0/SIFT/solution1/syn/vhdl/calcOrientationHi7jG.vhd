...
entity calcOrientationHi7jG_rom is 
    generic(
             DWIDTH     : integer := 24; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of calcOrientationHi7jG_rom is 
...
entity calcOrientationHi7jG is
    generic (
...
architecture arch of calcOrientationHi7jG is
    component calcOrientationHi7jG_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    calcOrientationHi7jG_rom_U :  component calcOrientationHi7jG_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

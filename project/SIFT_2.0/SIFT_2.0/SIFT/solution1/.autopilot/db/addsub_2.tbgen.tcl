...
set C_modelArgMapList {[ 
	{ "Name" : "a_V", "interface" : "wire", "bitwidth" : 40, "direction" : "READONLY"} , 
 	{ "Name" : "b_V", "interface" : "wire", "bitwidth" : 40, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ a_V sc_in sc_lv 40 signal 0 } 
	{ b_V sc_in sc_lv 40 signal 1 } 
	{ add_V sc_in sc_lv 1 signal 2 } 
	{ ap_return sc_out sc_lv 41 signal -1 } 
}
set NewPortList {[ 
	{ "name": "ap_ready", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "ready", "bundle":{"name": "ap_ready", "role": "default" }} , 
 	{ "name": "a_V", "direction": "in", "datatype": "sc_lv", "bitwidth":40, "type": "signal", "bundle":{"name": "a_V", "role": "default" }} , 
 	{ "name": "b_V", "direction": "in", "datatype": "sc_lv", "bitwidth":40, "type": "signal", "bundle":{"name": "b_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	a_V { ap_none {  { a_V in_data 0 40 } } }
	b_V { ap_none {  { b_V in_data 0 40 } } }

...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_rows_V_read { I 6 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_cols_V_read { I 6 vector } } \
} "
}

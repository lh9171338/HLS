...
entity HoughLinesProbabircU_rom is 
    generic(
             DWIDTH     : integer := 24; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of HoughLinesProbabircU_rom is 
...
entity HoughLinesProbabircU is
    generic (
...
architecture arch of HoughLinesProbabircU is
    component HoughLinesProbabircU_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    HoughLinesProbabircU_rom_U :  component HoughLinesProbabircU_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

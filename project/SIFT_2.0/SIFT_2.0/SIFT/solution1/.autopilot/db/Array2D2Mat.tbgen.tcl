...
set C_modelArgList {
	{ arr_val int 8 regular {array 4096 { 1 3 } 1 1 }  }
	{ mat_data_stream_V int 8 regular {fifo 1 volatile }  }
	{ mat_rows_V int 7 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "arr_val", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mat_rows_V", "interface" : "fifo", "bitwidth" : 7, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ arr_val_address0 sc_out sc_lv 12 signal 0 } 
	...
	{ mat_rows_V_din sc_out sc_lv 7 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arr_val_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "arr_val", "role": "address0" }} , 
 	...
 	{ "name": "mat_rows_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "mat_rows_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	arr_val { ap_memory {  { arr_val_address0 mem_address 1 12 }  { arr_val_ce0 mem_ce 1 1 }  { arr_val_q0 mem_dout 0 8 } } }
	...
	mat_rows_V { ap_fifo {  { mat_rows_V_din fifo_data 1 7 }  { mat_rows_V_full_n fifo_status 0 1 }  { mat_rows_V_write fifo_update 1 1 } } }

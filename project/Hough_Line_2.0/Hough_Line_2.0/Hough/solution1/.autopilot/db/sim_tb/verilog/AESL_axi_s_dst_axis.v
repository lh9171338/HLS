...
`define TV_OUT_dst_axis_TDATA "./impl_rtl.HoughLinesP_Core.autotvout_dst_axis_V_data_V.dat"
`define EGRESS_STATUS_dst_axis_TDATA "./stream_egress_status_dst_axis_V_data_V.dat"
`define TV_OUT_dst_axis_TKEEP "./impl_rtl.HoughLinesP_Core.autotvout_dst_axis_V_keep_V.dat"
`define EGRESS_STATUS_dst_axis_TKEEP "./stream_egress_status_dst_axis_V_keep_V.dat"
`define TV_OUT_dst_axis_TSTRB "./impl_rtl.HoughLinesP_Core.autotvout_dst_axis_V_strb_V.dat"
`define EGRESS_STATUS_dst_axis_TSTRB "./stream_egress_status_dst_axis_V_strb_V.dat"
`define TV_OUT_dst_axis_TUSER "./impl_rtl.HoughLinesP_Core.autotvout_dst_axis_V_user_V.dat"
`define EGRESS_STATUS_dst_axis_TUSER "./stream_egress_status_dst_axis_V_user_V.dat"
`define TV_OUT_dst_axis_TLAST "./impl_rtl.HoughLinesP_Core.autotvout_dst_axis_V_last_V.dat"
`define EGRESS_STATUS_dst_axis_TLAST "./stream_egress_status_dst_axis_V_last_V.dat"
`define TV_OUT_dst_axis_TID "./impl_rtl.HoughLinesP_Core.autotvout_dst_axis_V_id_V.dat"
`define EGRESS_STATUS_dst_axis_TID "./stream_egress_status_dst_axis_V_id_V.dat"
`define TV_OUT_dst_axis_TDEST "./impl_rtl.HoughLinesP_Core.autotvout_dst_axis_V_dest_V.dat"
...
module AESL_axi_s_dst_axis (
    input clk,
    input reset,
    input [16 - 1:0] TRAN_dst_axis_TDATA,
    input [2 - 1:0] TRAN_dst_axis_TKEEP,
    input [2 - 1:0] TRAN_dst_axis_TSTRB,
    ...
    reg [16 - 1:0] dst_axis_TDATA_write_data;
    reg dst_axis_TDATA_read_en;
    wire [16 - 1:0] dst_axis_TDATA_read_data;
    
    fifo #(400, 16) fifo_dst_axis_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [2 - 1:0] dst_axis_TKEEP_write_data;
    reg dst_axis_TKEEP_read_en;
    wire [2 - 1:0] dst_axis_TKEEP_read_data;
    
    fifo #(400, 2) fifo_dst_axis_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [2 - 1:0] dst_axis_TSTRB_write_data;
    reg dst_axis_TSTRB_read_en;
    wire [2 - 1:0] dst_axis_TSTRB_read_data;
    
    fifo #(400, 2) fifo_dst_axis_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(400, 1) fifo_dst_axis_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(400, 1) fifo_dst_axis_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(400, 1) fifo_dst_axis_TDEST (
        .reset(1'b0),
        .write_clock(clk),

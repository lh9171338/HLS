...
#ifndef __HoughCircles_CoreCeG__HH__
#define __HoughCircles_CoreCeG__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughCircles_CoreCeG) {
    ...
    SC_CTOR(HoughCircles_CoreCeG):  simcore_mac_7_U ("simcore_mac_7_U") {

...
#ifndef _SeedFill2_Core_HH_
#define _SeedFill2_Core_HH_
...
#include "SeedFill2_Core_srfYi.h"
#include "SeedFill2_Core_reg8j.h"
...
#include "start_for_Mat2Arrhbi.h"
#include "start_for_Mat2AXIibs.h"
#include "SeedFill2_Core_ctrl_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_CTRL_ADDR_WIDTH = 5,
         unsigned int C_S_AXI_CTRL_DATA_WIDTH = 32>
struct SeedFill2_Core : public sc_module {
    ...
    // Module declarations
    SeedFill2_Core(sc_module_name name);
    SC_HAS_PROCESS(SeedFill2_Core);
    ...
    SeedFill2_Core_ctrl_s_axi<C_S_AXI_CTRL_ADDR_WIDTH,C_S_AXI_CTRL_DATA_WIDTH>* SeedFill2_Core_ctrl_s_axi_U;
    SeedFill2_Core_srfYi* src_val_U;
    SeedFill2_Core_reg8j* rects_val_U;
    ...
    sc_signal< sc_lv<16> > rects_val_i_q0;
    sc_signal< sc_lv<16> > rects_val_t_q0;
    ...
    sc_signal< sc_lv<32> > Block_Mat_exit8_proc_U0_p_src_rows_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_p_src_rows_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit8_proc_U0_p_src_cols_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_p_src_cols_V_out_write;
    sc_signal< sc_lv<4> > Block_Mat_exit8_proc_U0_rects_rows_out_din;
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_rects_rows_out_write;
    sc_signal< sc_lv<10> > Block_Mat_exit8_proc_U0_rects_cols_out_din;
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_rects_cols_out_write;
    ...
    sc_signal< sc_lv<18> > Mat2Array2D_U0_arr_val_address0;
    ...
    sc_signal< sc_logic > SeedFilling_U0_ap_start;
    sc_signal< sc_logic > SeedFilling_U0_ap_done;
    sc_signal< sc_logic > SeedFilling_U0_ap_continue;
    sc_signal< sc_logic > SeedFilling_U0_ap_idle;
    sc_signal< sc_logic > SeedFilling_U0_ap_ready;
    sc_signal< sc_lv<18> > SeedFilling_U0_src_val_address0;
    sc_signal< sc_logic > SeedFilling_U0_src_val_ce0;
    sc_signal< sc_logic > SeedFilling_U0_src_rows_read;
    sc_signal< sc_logic > SeedFilling_U0_src_cols_read;
    sc_signal< sc_lv<10> > SeedFilling_U0_rects_val_address0;
    sc_signal< sc_logic > SeedFilling_U0_rects_val_ce0;
    sc_signal< sc_logic > SeedFilling_U0_rects_val_we0;
    sc_signal< sc_lv<16> > SeedFilling_U0_rects_val_d0;
    sc_signal< sc_lv<10> > SeedFilling_U0_rects_val_address1;
    sc_signal< sc_logic > SeedFilling_U0_rects_val_ce1;
    sc_signal< sc_logic > SeedFilling_U0_rects_val_we1;
    sc_signal< sc_lv<16> > SeedFilling_U0_rects_val_d1;
    sc_signal< sc_logic > SeedFilling_U0_rects_rows_read;
    sc_signal< sc_logic > SeedFilling_U0_rects_cols_read;
    sc_signal< sc_lv<4> > SeedFilling_U0_rects_rows_out_din;
    sc_signal< sc_logic > SeedFilling_U0_rects_rows_out_write;
    sc_signal< sc_lv<10> > SeedFilling_U0_rects_cols_out_din;
    sc_signal< sc_logic > SeedFilling_U0_rects_cols_out_write;
    sc_signal< sc_logic > ap_channel_done_rects_val;
    sc_signal< sc_logic > SeedFilling_U0_rects_val_full_n;
    ...
    sc_signal< sc_lv<10> > Array2D2Mat_U0_arr_val_address0;
    ...
    sc_signal< sc_lv<10> > Array2D2Mat_U0_mat_cols_V_din;
    ...
    sc_signal< sc_logic > rects_val_i_full_n;
    sc_signal< sc_logic > rects_val_t_empty_n;
    ...
    sc_signal< sc_logic > rects_rows_c_full_n;
    sc_signal< sc_lv<4> > rects_rows_c_dout;
    sc_signal< sc_logic > rects_rows_c_empty_n;
    sc_signal< sc_logic > rects_cols_c_full_n;
    sc_signal< sc_lv<10> > rects_cols_c_dout;
    sc_signal< sc_logic > rects_cols_c_empty_n;
    ...
    sc_signal< sc_logic > p_src_rows_V_c20_full_n;
    sc_signal< sc_lv<32> > p_src_rows_V_c20_dout;
    sc_signal< sc_logic > p_src_rows_V_c20_empty_n;
    sc_signal< sc_logic > p_src_cols_V_c21_full_n;
    sc_signal< sc_lv<32> > p_src_cols_V_c21_dout;
    sc_signal< sc_logic > p_src_cols_V_c21_empty_n;
    ...
    sc_signal< sc_logic > rects_rows_c22_full_n;
    sc_signal< sc_lv<4> > rects_rows_c22_dout;
    sc_signal< sc_logic > rects_rows_c22_empty_n;
    sc_signal< sc_logic > rects_cols_c23_full_n;
    sc_signal< sc_lv<10> > rects_cols_c23_dout;
    sc_signal< sc_logic > rects_cols_c23_empty_n;
    sc_signal< sc_logic > p_rects_data_stream_0_full_n;
    sc_signal< sc_lv<16> > p_rects_data_stream_0_dout;
    sc_signal< sc_logic > p_rects_data_stream_0_empty_n;
    sc_signal< sc_logic > p_rects_rows_V_c_full_n;
    sc_signal< sc_lv<4> > p_rects_rows_V_c_dout;
    sc_signal< sc_logic > p_rects_rows_V_c_empty_n;
    sc_signal< sc_logic > p_rects_cols_V_c_full_n;
    sc_signal< sc_lv<10> > p_rects_cols_V_c_dout;
    sc_signal< sc_logic > p_rects_cols_V_c_empty_n;
    ...
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_start_full_n;
    ...
    sc_signal< sc_logic > SeedFilling_U0_start_full_n;
    sc_signal< sc_logic > SeedFilling_U0_start_write;
    ...
    void thread_Block_Mat_exit8_proc_U0_start_full_n();
    void thread_Block_Mat_exit8_proc_U0_start_write();
    ...
    void thread_SeedFilling_U0_ap_continue();
    void thread_SeedFilling_U0_ap_start();
    void thread_SeedFilling_U0_rects_val_full_n();
    void thread_SeedFilling_U0_start_full_n();
    void thread_SeedFilling_U0_start_write();
    void thread_ap_channel_done_rects_val();

...
entity HoughLinesStandarjbC_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of HoughLinesStandarjbC_rom is 
...
entity HoughLinesStandarjbC is
    generic (
...
architecture arch of HoughLinesStandarjbC is
    component HoughLinesStandarjbC_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    HoughLinesStandarjbC_rom_U :  component HoughLinesStandarjbC_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

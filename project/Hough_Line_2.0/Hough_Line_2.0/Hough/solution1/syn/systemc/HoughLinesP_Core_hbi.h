...
#ifndef __HoughLinesP_Core_hbi__HH__
#define __HoughLinesP_Core_hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughLinesP_Core_hbi) {
    ...
    SC_CTOR(HoughLinesP_Core_hbi):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

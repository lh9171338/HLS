...
#ifndef _Duplicate181_HH_
#define _Duplicate181_HH_
...
struct Duplicate181 : public sc_module {
    ...
    // Module declarations
    Duplicate181(sc_module_name name);
    SC_HAS_PROCESS(Duplicate181);
    ...
    void thread_exitcond5_i_fu_110_p2();

...
set ID 1021
set hasByteEnable 0
set MemName calcSIFTDescriptobml
...
set ID 1022
set hasByteEnable 0
set MemName calcSIFTDescriptobnm
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 32
set AddrRange 128
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename descriptor_val \
    op interface \
    ports { descriptor_val_address0 { O 16 vector } descriptor_val_ce0 { O 1 bit } descriptor_val_we0 { O 1 bit } descriptor_val_d0 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'descriptor_val'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_val_V_offset { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 1037 \
    name descriptor_val_offset \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_descriptor_val_offset \
    op interface \
    ports { descriptor_val_offset { I 32 vector } } \
} "
}

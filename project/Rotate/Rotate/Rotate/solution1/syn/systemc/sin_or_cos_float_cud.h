...
#ifndef __sin_or_cos_float_cud_H__
#define __sin_or_cos_float_cud_H__
...
struct sin_or_cos_float_cud_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sin_or_cos_float_cud_ram) {
...
SC_MODULE(sin_or_cos_float_cud) {
...
sin_or_cos_float_cud_ram* meminst;


SC_CTOR(sin_or_cos_float_cud) {
meminst = new sin_or_cos_float_cud_ram("sin_or_cos_float_cud_ram");

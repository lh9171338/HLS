...
#ifndef __HoughLinesP_Core_Ffa__HH__
#define __HoughLinesP_Core_Ffa__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughLinesP_Core_Ffa) {
    ...
    SC_CTOR(HoughLinesP_Core_Ffa):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {

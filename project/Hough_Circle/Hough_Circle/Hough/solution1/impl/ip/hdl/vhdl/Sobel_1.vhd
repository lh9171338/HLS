...
architecture behav of Sobel_1 is 
    ...
    signal p_src_rows_V_read_reg_72 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal p_src_cols_V_read_reg_77 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_Filter2D_fu_48_ap_start : STD_LOGIC;
    signal grp_Filter2D_fu_48_ap_done : STD_LOGIC;
    signal grp_Filter2D_fu_48_ap_idle : STD_LOGIC;
    signal grp_Filter2D_fu_48_ap_ready : STD_LOGIC;
    signal grp_Filter2D_fu_48_p_src_data_stream_V_read : STD_LOGIC;
    signal grp_Filter2D_fu_48_p_dst_data_stream_V_din : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_Filter2D_fu_48_p_dst_data_stream_V_write : STD_LOGIC;
    signal grp_Filter2D_fu_48_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_Filter2D_fu_48 : component Filter2D
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_Filter2D_fu_48_ap_start,
        ap_done => grp_Filter2D_fu_48_ap_done,
        ap_idle => grp_Filter2D_fu_48_ap_idle,
        ap_ready => grp_Filter2D_fu_48_ap_ready,
        p_src_rows_V_read => p_src_rows_V_read_reg_72,
        p_src_cols_V_read => p_src_cols_V_read_reg_77,
        p_src_data_stream_V_dout => p_src_data_stream_V_dout,
        p_src_data_stream_V_empty_n => p_src_data_stream_V_empty_n,
        p_src_data_stream_V_read => grp_Filter2D_fu_48_p_src_data_stream_V_read,
        p_dst_data_stream_V_din => grp_Filter2D_fu_48_p_dst_data_stream_V_din,
        p_dst_data_stream_V_full_n => p_dst_data_stream_V_full_n,
        p_dst_data_stream_V_write => grp_Filter2D_fu_48_p_dst_data_stream_V_write,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_Filter2D_fu_48_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_Filter2D_fu_48_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((grp_Filter2D_fu_48_ap_ready = ap_const_logic_1)) then 
                    grp_Filter2D_fu_48_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (p_src_cols_V_empty_n = ap_const_logic_0) or (p_src_rows_V_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                p_src_cols_V_read_reg_77 <= p_src_cols_V_dout;
                p_src_rows_V_read_reg_72 <= p_src_rows_V_dout;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, p_src_rows_V_empty_n, p_src_cols_V_empty_n, grp_Filter2D_fu_48_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((grp_Filter2D_fu_48_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_Filter2D_fu_48_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_Filter2D_fu_48_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(grp_Filter2D_fu_48_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_Filter2D_fu_48_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_Filter2D_fu_48_ap_start <= grp_Filter2D_fu_48_ap_start_reg;
    p_dst_data_stream_V_din <= grp_Filter2D_fu_48_p_dst_data_stream_V_din;

    p_dst_data_stream_V_write_assign_proc : process(grp_Filter2D_fu_48_p_dst_data_stream_V_write, ap_CS_fsm_state2)
    begin
    ...
    p_src_data_stream_V_read_assign_proc : process(grp_Filter2D_fu_48_p_src_data_stream_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_src_data_stream_V_read <= grp_Filter2D_fu_48_p_src_data_stream_V_read;
        else 

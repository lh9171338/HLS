...
output  [31:0] lineGap_out_din;
input   lineGap_out_full_n;
output   lineGap_out_write;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (lineGap_out_full_n == 1'b0) | (thresh_out_full_n == 1'b0) | (lines_cols_out_full_n == 1'b0) | (lines_rows_out_full_n == 1'b0) | (src_cols_V_out_full_n == 1'b0) | (src_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (lineGap_out_full_n == 1'b0) | (thresh_out_full_n == 1'b0) | (lines_cols_out_full_n == 1'b0) | (lines_rows_out_full_n == 1'b0) | (src_cols_V_out_full_n == 1'b0) | (src_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        lineGap_out_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (lineGap_out_full_n == 1'b0) | (thresh_out_full_n == 1'b0) | (lines_cols_out_full_n == 1'b0) | (lines_rows_out_full_n == 1'b0) | (src_cols_V_out_full_n == 1'b0) | (src_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        lineGap_out_write = 1'b1;
    end else begin
        lineGap_out_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (lineGap_out_full_n == 1'b0) | (thresh_out_full_n == 1'b0) | (lines_cols_out_full_n == 1'b0) | (lines_rows_out_full_n == 1'b0) | (src_cols_V_out_full_n == 1'b0) | (src_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign lineGap_out_din = lineGap;

assign lines_cols_out_din = 8'd100;

assign lines_rows_out_din = 4'd4;

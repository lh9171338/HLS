...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module HaarCascadeClassilbW_rom (
...
initial begin
    $readmemh("./HaarCascadeClassilbW_rom.dat", ram0);
    $readmemh("./HaarCascadeClassilbW_rom.dat", ram1);
    $readmemh("./HaarCascadeClassilbW_rom.dat", ram2);
end
...
HaarCascadeClassilbW_rom HaarCascadeClassilbW_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

...
#ifndef __Haaris_Core_sitofOgC__HH__
#define __Haaris_Core_sitofOgC__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_sitofOgC) {
    ...
    SC_CTOR(Haaris_Core_sitofOgC):  ACMP_sitofp_U ("ACMP_sitofp_U") {

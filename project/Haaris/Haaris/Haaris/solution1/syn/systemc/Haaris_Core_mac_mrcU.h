...
#ifndef __Haaris_Core_mac_mrcU__HH__
#define __Haaris_Core_mac_mrcU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mrcU) {
    ...
    SC_CTOR(Haaris_Core_mac_mrcU):  simcore_mac_9_U ("simcore_mac_9_U") {

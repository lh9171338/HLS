...
#ifndef __Resize_mask_tablebkb_H__
#define __Resize_mask_tablebkb_H__
...
struct Resize_mask_tablebkb_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(Resize_mask_tablebkb_ram) {
...
SC_MODULE(Resize_mask_tablebkb) {
...
Resize_mask_tablebkb_ram* meminst;


SC_CTOR(Resize_mask_tablebkb) {
meminst = new Resize_mask_tablebkb_ram("Resize_mask_tablebkb_ram");

...
#ifndef __Haaris_Core_fcmp_QgW__HH__
#define __Haaris_Core_fcmp_QgW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_fcmp_QgW) {
    ...
    SC_CTOR(Haaris_Core_fcmp_QgW):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {

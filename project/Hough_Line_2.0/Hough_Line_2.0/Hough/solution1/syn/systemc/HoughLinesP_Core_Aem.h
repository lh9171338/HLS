...
#ifndef __HoughLinesP_Core_Aem__HH__
#define __HoughLinesP_Core_Aem__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughLinesP_Core_Aem) {
    ...
    SC_CTOR(HoughLinesP_Core_Aem):  ACMP_uitofp_U ("ACMP_uitofp_U") {

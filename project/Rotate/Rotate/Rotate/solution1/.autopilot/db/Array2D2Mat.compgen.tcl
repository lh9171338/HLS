...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { arr_rows_dout { I 17 vector } arr_rows_empty_n { I 1 bit } arr_rows_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { arr_cols_dout { I 17 vector } arr_cols_empty_n { I 1 bit } arr_cols_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { mat_rows_V_din { O 17 vector } mat_rows_V_full_n { I 1 bit } mat_rows_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { mat_cols_V_din { O 17 vector } mat_cols_V_full_n { I 1 bit } mat_cols_V_write { O 1 bit } } \
} "
}

...
wire   [7:0] label_val_i_q0;
wire   [7:0] label_val_t_q0;
...
wire   [17:0] SeedFilling_U0_label_val_address0;
wire    SeedFilling_U0_label_val_ce0;
wire    SeedFilling_U0_label_val_we0;
wire   [7:0] SeedFilling_U0_label_val_d0;
wire   [31:0] SeedFilling_U0_num;
wire    SeedFilling_U0_num_ap_vld;
wire   [31:0] SeedFilling_U0_label_rows_din;
wire    SeedFilling_U0_label_rows_write;
wire   [31:0] SeedFilling_U0_label_cols_din;
wire    SeedFilling_U0_label_cols_write;
wire    ap_channel_done_label_val;
wire    SeedFilling_U0_label_val_full_n;
reg    ap_sync_reg_channel_write_label_val;
wire    ap_sync_channel_write_label_val;
...
wire    label_val_i_full_n;
wire    label_val_t_empty_n;
...
wire    label_rows_c_full_n;
wire   [31:0] label_rows_c_dout;
wire    label_rows_c_empty_n;
wire    label_cols_c_full_n;
wire   [31:0] label_cols_c_dout;
wire    label_cols_c_empty_n;
wire    p_label_data_stream_0_full_n;
wire   [7:0] p_label_data_stream_0_dout;
wire    p_label_data_stream_0_empty_n;
wire    p_label_rows_V_c_full_n;
wire   [31:0] p_label_rows_V_c_dout;
wire    p_label_rows_V_c_empty_n;
wire    p_label_cols_V_c_full_n;
wire   [31:0] p_label_cols_V_c_dout;
wire    p_label_cols_V_c_empty_n;
wire    ap_sync_done;
wire    ap_sync_ready;
...
initial begin
#0 ap_sync_reg_channel_write_label_val = 1'b0;
...
SeedFilling1_Core_ctrl_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_CTRL_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_CTRL_DATA_WIDTH ))
SeedFilling1_Core_ctrl_s_axi_U(
...
fifo_w8_d2_A p_label_data_stream_0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A p_label_rows_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A p_label_cols_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_Mat2Arrg8j start_for_Mat2Arrg8j_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_channel_write_label_val <= 1'b0;
    end else begin
        if (((SeedFilling_U0_ap_done & SeedFilling_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_label_val <= 1'b0;
        end else begin
...
assign Array2D2Mat_U0_ap_start = label_val_t_empty_n;
...
assign SeedFilling_U0_ap_continue = (ap_sync_continue & ap_sync_channel_write_label_val);

assign SeedFilling_U0_ap_start = src_val_t_empty_n;

assign SeedFilling_U0_label_val_full_n = label_val_i_full_n;

assign SeedFilling_U0_start_full_n = 1'b1;

assign SeedFilling_U0_start_write = 1'b0;

assign ap_channel_done_label_val = ((ap_sync_reg_channel_write_label_val ^ 1'b1) & SeedFilling_U0_ap_done);

assign ap_channel_done_src_val = Mat2Array2D_U0_ap_done;

assign ap_done = ap_sync_done;

assign ap_idle = ((label_val_t_empty_n ^ 1'b1) & (src_val_t_empty_n ^ 1'b1) & SeedFilling_U0_ap_idle & Mat2Array2D_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & Block_Mat_exit5_proc_U0_ap_idle & Array2D2Mat_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign ap_sync_channel_write_label_val = ((ap_channel_done_label_val & SeedFilling_U0_label_val_full_n) | ap_sync_reg_channel_write_label_val);

assign ap_sync_continue = ap_sync_done;

assign ap_sync_done = (SeedFilling_U0_ap_done & Mat2AXIvideo_U0_ap_done);

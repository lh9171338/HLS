...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_axis_TVALID { O 1 bit } dst_axis_TREADY { I 1 bit } dst_axis_TDEST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_rows_V_dout { I 1 vector } img_rows_V_empty_n { I 1 bit } img_rows_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_cols_V_dout { I 8 vector } img_cols_V_empty_n { I 1 bit } img_cols_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_data_stream_0_V_dout { I 16 vector } img_data_stream_0_V_empty_n { I 1 bit } img_data_stream_0_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_data_stream_1_V_dout { I 16 vector } img_data_stream_1_V_empty_n { I 1 bit } img_data_stream_1_V_read { O 1 bit } } \
} "
}

...
entity Resize_mask_tablebkb_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of Resize_mask_tablebkb_rom is 
...
entity Resize_mask_tablebkb is
    generic (
...
architecture arch of Resize_mask_tablebkb is
    component Resize_mask_tablebkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Resize_mask_tablebkb_rom_U :  component Resize_mask_tablebkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

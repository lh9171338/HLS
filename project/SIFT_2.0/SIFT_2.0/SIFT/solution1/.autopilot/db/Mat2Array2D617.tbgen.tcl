...
set C_modelName {Mat2Array2D617}
...
set C_modelArgList {
	...
	{ arr_rows_out int 32 regular {fifo 1}  }
	{ arr_cols_out int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mat_rows_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "arr_rows_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "arr_cols_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ arr_rows_out_din sc_out sc_lv 32 signal 4 } 
	{ arr_rows_out_full_n sc_in sc_logic 1 signal 4 } 
	{ arr_rows_out_write sc_out sc_logic 1 signal 4 } 
	{ arr_cols_out_din sc_out sc_lv 32 signal 5 } 
	{ arr_cols_out_full_n sc_in sc_logic 1 signal 5 } 
	{ arr_cols_out_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arr_rows_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "arr_rows_out", "role": "din" }} , 
 	{ "name": "arr_rows_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "arr_rows_out", "role": "full_n" }} , 
 	{ "name": "arr_rows_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "arr_rows_out", "role": "write" }} , 
 	{ "name": "arr_cols_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "arr_cols_out", "role": "din" }} , 
 	{ "name": "arr_cols_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "arr_cols_out", "role": "full_n" }} , 
 	{ "name": "arr_cols_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "arr_cols_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "arr_rows_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "arr_rows_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "arr_cols_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	arr_rows_out { ap_fifo {  { arr_rows_out_din fifo_data 1 32 }  { arr_rows_out_full_n fifo_status 0 1 }  { arr_rows_out_write fifo_update 1 1 } } }
	arr_cols_out { ap_fifo {  { arr_cols_out_din fifo_data 1 32 }  { arr_cols_out_full_n fifo_status 0 1 }  { arr_cols_out_write fifo_update 1 1 } } }
}

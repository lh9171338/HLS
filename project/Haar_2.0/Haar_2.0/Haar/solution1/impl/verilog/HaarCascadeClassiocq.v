...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module HaarCascadeClassiocq_rom (
...
initial begin
    $readmemh("./HaarCascadeClassiocq_rom.dat", ram0);
    $readmemh("./HaarCascadeClassiocq_rom.dat", ram1);
    $readmemh("./HaarCascadeClassiocq_rom.dat", ram2);
end
...
HaarCascadeClassiocq_rom HaarCascadeClassiocq_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

...
always @ (posedge ap_clk) begin
    if (((tmp_i_fu_153_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        j_i_reg_128 <= 31'd0;
    end else if (((tmp_45_i_fu_168_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_45_i_fu_168_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_s_reg_230 <= tmp_s_fu_183_p2;
    end
end

always @ (*) begin
    if ((tmp_45_i_fu_168_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((tmp_45_i_reg_221 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        arr_val_we0 = 1'b1;
    end else begin
        arr_val_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((tmp_45_i_reg_221 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (tmp_45_i_fu_168_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (tmp_45_i_fu_168_p2 == 1'd0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((tmp_45_i_reg_221 == 1'd1) & (mat_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((tmp_45_i_reg_221 == 1'd1) & (mat_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((tmp_45_i_reg_221 == 1'd1) & (mat_data_stream_V_empty_n == 1'b0));
end
...
assign arr_val_address0 = tmp_14_cast_fu_188_p1;
...
assign tmp_14_cast_fu_188_p1 = tmp_s_reg_230;

assign tmp_23_fu_179_p1 = j_i_reg_128[18:0];

assign tmp_45_i_fu_168_p2 = (($signed(j_cast_i_fu_164_p1) < $signed(cols_reg_197)) ? 1'b1 : 1'b0);

assign tmp_fu_139_p1 = phi_mul_reg_117[18:0];

assign tmp_i_fu_153_p2 = (($signed(i_cast_i_fu_149_p1) < $signed(rows_reg_192)) ? 1'b1 : 1'b0);

assign tmp_s_fu_183_p2 = (tmp_reg_202 + tmp_23_fu_179_p1);

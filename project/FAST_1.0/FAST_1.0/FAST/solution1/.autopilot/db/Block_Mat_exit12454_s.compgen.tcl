...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_rows_V_out_din { O 32 vector } p_dst_rows_V_out_full_n { I 1 bit } p_dst_rows_V_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_cols_V_out_din { O 32 vector } p_dst_cols_V_out_full_n { I 1 bit } p_dst_cols_V_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 17 \
    name src0_rows_V_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_src0_rows_V_out \
    op interface \
    ports { src0_rows_V_out_din { O 32 vector } src0_rows_V_out_full_n { I 1 bit } src0_rows_V_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 18 \
    name src0_cols_V_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_src0_cols_V_out \
    op interface \
    ports { src0_cols_V_out_din { O 32 vector } src0_cols_V_out_full_n { I 1 bit } src0_cols_V_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 19 \
    name src1_rows_V_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_src1_rows_V_out \
    op interface \
    ports { src1_rows_V_out_din { O 32 vector } src1_rows_V_out_full_n { I 1 bit } src1_rows_V_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 20 \
    name src1_cols_V_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_src1_cols_V_out \
    op interface \
    ports { src1_cols_V_out_din { O 32 vector } src1_cols_V_out_full_n { I 1 bit } src1_cols_V_out_write { O 1 bit } } \
} "
}

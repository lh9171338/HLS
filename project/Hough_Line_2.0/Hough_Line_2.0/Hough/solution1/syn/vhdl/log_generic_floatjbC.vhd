...
entity log_generic_floatjbC_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of log_generic_floatjbC_rom is 
...
entity log_generic_floatjbC is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of log_generic_floatjbC is
    component log_generic_floatjbC_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    log_generic_floatjbC_rom_U :  component log_generic_floatjbC_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

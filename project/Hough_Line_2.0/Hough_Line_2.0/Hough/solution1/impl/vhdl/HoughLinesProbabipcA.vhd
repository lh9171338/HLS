...
entity HoughLinesProbabipcA_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of HoughLinesProbabipcA_rom is 
...
entity HoughLinesProbabipcA is
    generic (
...
architecture arch of HoughLinesProbabipcA is
    component HoughLinesProbabipcA_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    HoughLinesProbabipcA_rom_U :  component HoughLinesProbabipcA_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

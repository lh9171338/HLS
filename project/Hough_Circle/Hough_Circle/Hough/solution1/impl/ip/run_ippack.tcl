...
set Library     "hls"
set IPName      "HoughCircles_Core"
set Version     "1.0"
set DisplayName "Houghcircles_core"
set Revision    "1812040951"
...
set Interfaces {
    s_axi_ctrl {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 rows W 0x0 "Data signal of rows" {{0 32 rows W 0 "Bit 31 to 0 Data signal of rows"}}} {0x18 cols W 0x0 "Data signal of cols" {{0 32 cols W 0 "Bit 31 to 0 Data signal of cols"}}} {0x20 gray_thresh W 0x0 "Data signal of gray_thresh" {{0 32 gray_thresh W 0 "Bit 31 to 0 Data signal of gray_thresh"}}} {0x28 acc_thresh W 0x0 "Data signal of acc_thresh" {{0 32 acc_thresh W 0 "Bit 31 to 0 Data signal of acc_thresh"}}} {0x30 min_dist W 0x0 "Data signal of min_dist" {{0 32 min_dist W 0 "Bit 31 to 0 Data signal of min_dist"}}} {0x38 min_radius W 0x0 "Data signal of min_radius" {{0 32 min_radius W 0 "Bit 31 to 0 Data signal of min_radius"}}} {0x40 max_radius W 0x0 "Data signal of max_radius" {{0 32 max_radius W 0 "Bit 31 to 0 Data signal of max_radius"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"

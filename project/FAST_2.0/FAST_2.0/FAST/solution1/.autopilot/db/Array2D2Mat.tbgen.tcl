...
set C_modelArgMapList {[ 
	{ "Name" : "arr_val", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "arr_cols", "interface" : "fifo", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mat_cols_V", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ arr_cols_dout sc_in sc_lv 11 signal 2 } 
	...
	{ mat_cols_V_din sc_out sc_lv 11 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arr_cols_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "arr_cols", "role": "dout" }} , 
 	...
 	{ "name": "mat_cols_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "mat_cols_V", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1", "EstimateLatencyMax" : "2007",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "2007"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "2007"}
]}
...
set Spec2ImplPortList { 
	arr_val { ap_memory {  { arr_val_address0 mem_address 1 11 }  { arr_val_ce0 mem_ce 1 1 }  { arr_val_q0 mem_dout 0 16 } } }
	arr_rows { ap_fifo {  { arr_rows_dout fifo_data 0 3 }  { arr_rows_empty_n fifo_status 0 1 }  { arr_rows_read fifo_update 1 1 } } }
	arr_cols { ap_fifo {  { arr_cols_dout fifo_data 0 11 }  { arr_cols_empty_n fifo_status 0 1 }  { arr_cols_read fifo_update 1 1 } } }
	...
	mat_cols_V { ap_fifo {  { mat_cols_V_din fifo_data 1 11 }  { mat_cols_V_full_n fifo_status 0 1 }  { mat_cols_V_write fifo_update 1 1 } } }
}

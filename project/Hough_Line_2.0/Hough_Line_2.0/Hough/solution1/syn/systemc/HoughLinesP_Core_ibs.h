...
#ifndef __HoughLinesP_Core_ibs__HH__
#define __HoughLinesP_Core_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughLinesP_Core_ibs) {
    ...
    SC_CTOR(HoughLinesP_Core_ibs):  ACMP_smul_su_U ("ACMP_smul_su_U") {

...
void HoughCircles_CoreFfa::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void HoughCircles_CoreFfa::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void HoughCircles_CoreFfa::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void HoughCircles_CoreFfa::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {

...
#ifndef __HoughCircles_Coreibs__HH__
#define __HoughCircles_Coreibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughCircles_Coreibs) {
    ...
    SC_CTOR(HoughCircles_Coreibs):  simcore_mac_3_U ("simcore_mac_3_U") {

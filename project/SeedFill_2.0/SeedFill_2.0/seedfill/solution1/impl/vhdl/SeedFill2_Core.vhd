...
architecture behav of SeedFill2_Core is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "SeedFill2_Core,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7vx690tffg1761-3,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.717062,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=513,HLS_SYN_DSP=1,HLS_SYN_FF=2001,HLS_SYN_LUT=4093,HLS_VERSION=2018_2}";
    ...
    signal rects_val_i_q0 : STD_LOGIC_VECTOR (15 downto 0);
    signal rects_val_t_q0 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal Block_Mat_exit8_proc_U0_p_src_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit8_proc_U0_p_src_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit8_proc_U0_p_src_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit8_proc_U0_p_src_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit8_proc_U0_rects_rows_out_din : STD_LOGIC_VECTOR (3 downto 0);
    signal Block_Mat_exit8_proc_U0_rects_rows_out_write : STD_LOGIC;
    signal Block_Mat_exit8_proc_U0_rects_cols_out_din : STD_LOGIC_VECTOR (9 downto 0);
    signal Block_Mat_exit8_proc_U0_rects_cols_out_write : STD_LOGIC;
    ...
    signal SeedFilling_U0_rects_val_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal SeedFilling_U0_rects_val_ce0 : STD_LOGIC;
    signal SeedFilling_U0_rects_val_we0 : STD_LOGIC;
    signal SeedFilling_U0_rects_val_d0 : STD_LOGIC_VECTOR (15 downto 0);
    signal SeedFilling_U0_rects_val_address1 : STD_LOGIC_VECTOR (9 downto 0);
    signal SeedFilling_U0_rects_val_ce1 : STD_LOGIC;
    signal SeedFilling_U0_rects_val_we1 : STD_LOGIC;
    signal SeedFilling_U0_rects_val_d1 : STD_LOGIC_VECTOR (15 downto 0);
    signal SeedFilling_U0_rects_rows_read : STD_LOGIC;
    signal SeedFilling_U0_rects_cols_read : STD_LOGIC;
    signal SeedFilling_U0_rects_rows_out_din : STD_LOGIC_VECTOR (3 downto 0);
    signal SeedFilling_U0_rects_rows_out_write : STD_LOGIC;
    signal SeedFilling_U0_rects_cols_out_din : STD_LOGIC_VECTOR (9 downto 0);
    signal SeedFilling_U0_rects_cols_out_write : STD_LOGIC;
    signal ap_channel_done_rects_val : STD_LOGIC;
    signal SeedFilling_U0_rects_val_full_n : STD_LOGIC;
    ...
    signal Array2D2Mat_U0_arr_val_address0 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal Array2D2Mat_U0_mat_cols_V_din : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal rects_val_i_full_n : STD_LOGIC;
    signal rects_val_t_empty_n : STD_LOGIC;
    ...
    signal rects_rows_c_full_n : STD_LOGIC;
    signal rects_rows_c_dout : STD_LOGIC_VECTOR (3 downto 0);
    signal rects_rows_c_empty_n : STD_LOGIC;
    signal rects_cols_c_full_n : STD_LOGIC;
    signal rects_cols_c_dout : STD_LOGIC_VECTOR (9 downto 0);
    signal rects_cols_c_empty_n : STD_LOGIC;
    ...
    signal p_src_rows_V_c20_full_n : STD_LOGIC;
    signal p_src_rows_V_c20_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal p_src_rows_V_c20_empty_n : STD_LOGIC;
    signal p_src_cols_V_c21_full_n : STD_LOGIC;
    signal p_src_cols_V_c21_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal p_src_cols_V_c21_empty_n : STD_LOGIC;
    ...
    signal rects_rows_c22_full_n : STD_LOGIC;
    signal rects_rows_c22_dout : STD_LOGIC_VECTOR (3 downto 0);
    signal rects_rows_c22_empty_n : STD_LOGIC;
    signal rects_cols_c23_full_n : STD_LOGIC;
    signal rects_cols_c23_dout : STD_LOGIC_VECTOR (9 downto 0);
    signal rects_cols_c23_empty_n : STD_LOGIC;
    signal p_rects_data_stream_0_full_n : STD_LOGIC;
    signal p_rects_data_stream_0_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal p_rects_data_stream_0_empty_n : STD_LOGIC;
    signal p_rects_rows_V_c_full_n : STD_LOGIC;
    signal p_rects_rows_V_c_dout : STD_LOGIC_VECTOR (3 downto 0);
    signal p_rects_rows_V_c_empty_n : STD_LOGIC;
    signal p_rects_cols_V_c_full_n : STD_LOGIC;
    signal p_rects_cols_V_c_dout : STD_LOGIC_VECTOR (9 downto 0);
    signal p_rects_cols_V_c_empty_n : STD_LOGIC;
    ...
    port (
        ...
        start_out : OUT STD_LOGIC;
        start_write : OUT STD_LOGIC;
        arr_val_address0 : OUT STD_LOGIC_VECTOR (9 downto 0);
        arr_val_ce0 : OUT STD_LOGIC;
        ...
        arr_cols_dout : IN STD_LOGIC_VECTOR (9 downto 0);
        ...
        mat_cols_V_din : OUT STD_LOGIC_VECTOR (9 downto 0);
    ...
    component SeedFill2_Core_srfYi IS
    generic (
        DataWidth : INTEGER;
    ...
    component SeedFill2_Core_reg8j IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component start_for_Mat2Arrhbi IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Mat2AXIibs IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component SeedFill2_Core_ctrl_s_axi IS
    generic (
...
begin
    SeedFill2_Core_ctrl_s_axi_U : component SeedFill2_Core_ctrl_s_axi
    generic map (
    ...
    src_val_U : component SeedFill2_Core_srfYi
    generic map (
        DataWidth => 8,
        AddressRange => 250000,
        AddressWidth => 18)
    ...
    rects_val_U : component SeedFill2_Core_reg8j
    generic map (
        DataWidth => 16,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    rects_rows_c_U : component fifo_w4_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    rects_cols_c_U : component fifo_w10_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_src_rows_V_c20_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_src_cols_V_c21_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    rects_rows_c22_U : component fifo_w4_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    rects_cols_c23_U : component fifo_w10_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_rects_data_stream_0_U : component fifo_w16_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_rects_rows_V_c_U : component fifo_w4_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_rects_cols_V_c_U : component fifo_w10_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Mat2Arrhbi_U : component start_for_Mat2Arrhbi
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Mat2AXIibs_U : component start_for_Mat2AXIibs
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    Array2D2Mat_U0_ap_start <= rects_val_t_empty_n;
    ...
    SeedFilling_U0_ap_continue <= rects_val_i_full_n;
    SeedFilling_U0_ap_start <= src_val_t_empty_n;
    SeedFilling_U0_rects_val_full_n <= rects_val_i_full_n;
    SeedFilling_U0_start_full_n <= ap_const_logic_1;
    SeedFilling_U0_start_write <= ap_const_logic_0;
    ap_channel_done_rects_val <= SeedFilling_U0_ap_done;
    ap_channel_done_src_val <= Mat2Array2D_U0_ap_done;
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= ((rects_val_t_empty_n xor ap_const_logic_1) and (src_val_t_empty_n xor ap_const_logic_1) and SeedFilling_U0_ap_idle and Mat2Array2D_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and Block_Mat_exit8_proc_U0_ap_idle and Array2D2Mat_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);

...
architecture behav of HoughLinesP_Core is 
    ...
    signal lineGap : STD_LOGIC_VECTOR (31 downto 0);
    signal edge_val_i_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal edge_val_t_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal lines_val_i_q0 : STD_LOGIC_VECTOR (15 downto 0);
    signal lines_val_t_q0 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal Block_Mat_exit8_proc_U0_src_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit8_proc_U0_src_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit8_proc_U0_src_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit8_proc_U0_src_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit8_proc_U0_lines_rows_out_din : STD_LOGIC_VECTOR (3 downto 0);
    signal Block_Mat_exit8_proc_U0_lines_rows_out_write : STD_LOGIC;
    signal Block_Mat_exit8_proc_U0_lines_cols_out_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Block_Mat_exit8_proc_U0_lines_cols_out_write : STD_LOGIC;
    signal Block_Mat_exit8_proc_U0_thresh_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit8_proc_U0_thresh_out_write : STD_LOGIC;
    signal Block_Mat_exit8_proc_U0_lineGap_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit8_proc_U0_lineGap_out_write : STD_LOGIC;
    ...
    signal ap_channel_done_edge_val : STD_LOGIC;
    signal Mat2Array2D_U0_arr_val_full_n : STD_LOGIC;
    signal HoughLinesProbabilis_U0_ap_start : STD_LOGIC;
    signal HoughLinesProbabilis_U0_ap_done : STD_LOGIC;
    signal HoughLinesProbabilis_U0_ap_continue : STD_LOGIC;
    signal HoughLinesProbabilis_U0_ap_idle : STD_LOGIC;
    signal HoughLinesProbabilis_U0_ap_ready : STD_LOGIC;
    signal HoughLinesProbabilis_U0_edge_val_address0 : STD_LOGIC_VECTOR (16 downto 0);
    signal HoughLinesProbabilis_U0_edge_val_ce0 : STD_LOGIC;
    signal HoughLinesProbabilis_U0_edge_rows_read : STD_LOGIC;
    signal HoughLinesProbabilis_U0_edge_cols_read : STD_LOGIC;
    signal HoughLinesProbabilis_U0_lines_val_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal HoughLinesProbabilis_U0_lines_val_ce0 : STD_LOGIC;
    signal HoughLinesProbabilis_U0_lines_val_we0 : STD_LOGIC;
    signal HoughLinesProbabilis_U0_lines_val_d0 : STD_LOGIC_VECTOR (15 downto 0);
    signal HoughLinesProbabilis_U0_lines_val_address1 : STD_LOGIC_VECTOR (8 downto 0);
    signal HoughLinesProbabilis_U0_lines_val_ce1 : STD_LOGIC;
    signal HoughLinesProbabilis_U0_lines_val_we1 : STD_LOGIC;
    signal HoughLinesProbabilis_U0_lines_val_d1 : STD_LOGIC_VECTOR (15 downto 0);
    signal HoughLinesProbabilis_U0_lines_rows_read : STD_LOGIC;
    signal HoughLinesProbabilis_U0_lines_cols_read : STD_LOGIC;
    signal HoughLinesProbabilis_U0_threshold_read : STD_LOGIC;
    signal HoughLinesProbabilis_U0_lineGap_read : STD_LOGIC;
    signal HoughLinesProbabilis_U0_lines_rows_out_din : STD_LOGIC_VECTOR (3 downto 0);
    signal HoughLinesProbabilis_U0_lines_rows_out_write : STD_LOGIC;
    signal HoughLinesProbabilis_U0_lines_cols_out_din : STD_LOGIC_VECTOR (7 downto 0);
    signal HoughLinesProbabilis_U0_lines_cols_out_write : STD_LOGIC;
    signal ap_channel_done_lines_val : STD_LOGIC;
    signal HoughLinesProbabilis_U0_lines_val_full_n : STD_LOGIC;
    ...
    signal edge_val_i_full_n : STD_LOGIC;
    signal edge_val_t_empty_n : STD_LOGIC;
    signal lines_val_i_full_n : STD_LOGIC;
    signal lines_val_t_empty_n : STD_LOGIC;
    ...
    signal lines_rows_c_full_n : STD_LOGIC;
    signal lines_rows_c_dout : STD_LOGIC_VECTOR (3 downto 0);
    signal lines_rows_c_empty_n : STD_LOGIC;
    signal lines_cols_c_full_n : STD_LOGIC;
    signal lines_cols_c_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal lines_cols_c_empty_n : STD_LOGIC;
    signal thresh_c_full_n : STD_LOGIC;
    signal thresh_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal thresh_c_empty_n : STD_LOGIC;
    signal lineGap_c_full_n : STD_LOGIC;
    signal lineGap_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal lineGap_c_empty_n : STD_LOGIC;
    ...
    signal src_rows_V_c20_full_n : STD_LOGIC;
    signal src_rows_V_c20_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal src_rows_V_c20_empty_n : STD_LOGIC;
    signal src_cols_V_c21_full_n : STD_LOGIC;
    signal src_cols_V_c21_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal src_cols_V_c21_empty_n : STD_LOGIC;
    signal edge_rows_c_full_n : STD_LOGIC;
    signal edge_rows_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal edge_rows_c_empty_n : STD_LOGIC;
    signal edge_cols_c_full_n : STD_LOGIC;
    signal edge_cols_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal edge_cols_c_empty_n : STD_LOGIC;
    signal lines_rows_c22_full_n : STD_LOGIC;
    signal lines_rows_c22_dout : STD_LOGIC_VECTOR (3 downto 0);
    signal lines_rows_c22_empty_n : STD_LOGIC;
    signal lines_cols_c23_full_n : STD_LOGIC;
    signal lines_cols_c23_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal lines_cols_c23_empty_n : STD_LOGIC;
    ...
    signal dst_rows_V_c_dout : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal Block_Mat_exit8_proc_U0_start_full_n : STD_LOGIC;
    ...
    signal HoughLinesProbabilis_U0_start_full_n : STD_LOGIC;
    signal HoughLinesProbabilis_U0_start_write : STD_LOGIC;
    ...
    port (
        ...
        lineGap : IN STD_LOGIC_VECTOR (31 downto 0);
        ...
        lineGap_out_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        lineGap_out_full_n : IN STD_LOGIC;
        lineGap_out_write : OUT STD_LOGIC );
    end component;
    ...
    component HoughLinesProbabilis IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component HoughLinesP_Core_Gfk IS
    generic (
        DataWidth : INTEGER;
    ...
    component HoughLinesP_Core_Hfu IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component HoughLinesP_Core_ctrl_s_axi IS
    generic (
    ...
    port (
        ...
        lineGap : OUT STD_LOGIC_VECTOR (31 downto 0) );
    end component;



begin
    HoughLinesP_Core_ctrl_s_axi_U : component HoughLinesP_Core_ctrl_s_axi
    generic map (
    ...
    edge_val_U : component HoughLinesP_Core_Gfk
    generic map (
        DataWidth => 8,
        AddressRange => 76800,
        AddressWidth => 17)
    ...
    lines_val_U : component HoughLinesP_Core_Hfu
    generic map (
        DataWidth => 16,
        AddressRange => 400,
        AddressWidth => 9)
    ...
    HoughLinesProbabilis_U0 : component HoughLinesProbabilis
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    lines_rows_c_U : component fifo_w4_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    lines_cols_c_U : component fifo_w8_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    lineGap_c_U : component fifo_w32_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_rows_V_c20_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_cols_V_c21_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    edge_rows_c_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    edge_cols_c_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    lines_rows_c22_U : component fifo_w4_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    lines_cols_c23_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dst_rows_V_c_U : component fifo_w4_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dst_cols_V_c_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (ap_const_logic_0 = Block_Mat_exit8_proc_U0_ap_ready))) then 
    ...
    Array2D2Mat_U0_ap_start <= lines_val_t_empty_n;
    ...
    HoughLinesProbabilis_U0_ap_continue <= lines_val_i_full_n;
    HoughLinesProbabilis_U0_ap_start <= edge_val_t_empty_n;
    HoughLinesProbabilis_U0_lines_val_full_n <= lines_val_i_full_n;
    ...
    Mat2Array2D_U0_ap_continue <= edge_val_i_full_n;
    Mat2Array2D_U0_ap_start <= start_for_Mat2Array2D_U0_empty_n;
    Mat2Array2D_U0_arr_val_full_n <= edge_val_i_full_n;
    Mat2Array2D_U0_start_full_n <= ap_const_logic_1;
    Mat2Array2D_U0_start_write <= ap_const_logic_0;
    ap_channel_done_edge_val <= Mat2Array2D_U0_ap_done;
    ap_channel_done_lines_val <= HoughLinesProbabilis_U0_ap_done;
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= ((lines_val_t_empty_n xor ap_const_logic_1) and (edge_val_t_empty_n xor ap_const_logic_1) and Mat2Array2D_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and HoughLinesProbabilis_U0_ap_idle and Block_Mat_exit8_proc_U0_ap_idle and Array2D2Mat_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);

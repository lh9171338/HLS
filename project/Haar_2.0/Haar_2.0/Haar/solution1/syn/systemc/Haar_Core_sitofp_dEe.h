...
#ifndef __Haar_Core_sitofp_dEe__HH__
#define __Haar_Core_sitofp_dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haar_Core_sitofp_dEe) {
    ...
    SC_CTOR(Haar_Core_sitofp_dEe):  ACMP_sitofp_U ("ACMP_sitofp_U") {

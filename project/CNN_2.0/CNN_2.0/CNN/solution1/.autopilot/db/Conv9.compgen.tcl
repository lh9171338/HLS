...
set out_width 11
set exp (i0+i1)*i2
set arg_lists {i0 {1 1 +} i1 {5 0 +} s {6 1 +} i2 {11 1 +} p {11 1 +} c_expval {c} acc {0} }
set TrueReset 0
...
set ID 104
set hasByteEnable 0
set MemName Conv9_LineBuffer_wdI
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename src_val_V \
    op interface \
    ports { src_val_V_address0 { O 12 vector } src_val_V_ce0 { O 1 bit } src_val_V_q0 { I 32 vector } } \
} "
} else {

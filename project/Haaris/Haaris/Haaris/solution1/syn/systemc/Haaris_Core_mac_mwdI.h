...
#ifndef __Haaris_Core_mac_mwdI__HH__
#define __Haaris_Core_mac_mwdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mwdI) {
    ...
    SC_CTOR(Haaris_Core_mac_mwdI):  simcore_mac_14_U ("simcore_mac_14_U") {

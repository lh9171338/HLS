...
reg    src_axis_TDATA_blk_n;
wire    ap_CS_fsm_state2;
wire    ap_CS_fsm_pp1_stage0;
reg    ap_enable_reg_pp1_iter1;
wire    ap_block_pp1_stage0;
reg   [0:0] exitcond_i_reg_420;
reg   [0:0] brmerge_i_reg_429;
wire    ap_CS_fsm_pp2_stage0;
reg    ap_enable_reg_pp2_iter1;
wire    ap_block_pp2_stage0;
reg   [0:0] eol_2_i_reg_264;
...
reg   [31:0] t_V_18_reg_194;
reg   [0:0] eol_i_reg_205;
reg   [0:0] eol_reg_217;
reg   [31:0] axi_data_V_1_i_reg_228;
reg   [0:0] axi_last_V_3_i_reg_275;
reg   [31:0] axi_data_V_3_i_reg_287;
reg   [31:0] rows_V_reg_381;
reg    ap_block_state1;
reg   [31:0] cols_V_reg_386;
reg   [31:0] tmp_data_V_reg_391;
reg   [0:0] tmp_last_V_reg_399;
wire   [0:0] exitcond9_i_fu_318_p2;
wire    ap_CS_fsm_state4;
wire   [31:0] i_V_fu_323_p2;
reg   [31:0] i_V_reg_415;
wire   [0:0] exitcond_i_fu_329_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_predicate_op71_read_state6;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [31:0] j_V_fu_334_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [0:0] brmerge_i_fu_343_p2;
...
reg   [0:0] ap_phi_mux_eol_2_i_phi_fu_267_p4;
reg   [0:0] axi_last_V1_i_reg_163;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state3;
reg   [31:0] axi_data_V1_i_reg_173;
reg   [31:0] t_V_reg_183;
reg   [0:0] ap_phi_mux_eol_i_phi_fu_209_p4;
reg   [0:0] ap_phi_mux_axi_last_V_2_i_phi_fu_244_p4;
reg   [31:0] ap_phi_mux_p_Val2_s_phi_fu_256_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_239;
wire   [31:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_252;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond9_i_fu_318_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_fu_329_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond9_i_fu_318_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_phi_mux_eol_2_i_phi_fu_267_p4 == 1'd1) & (1'b0 == ap_block_pp2_stage0_subdone) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
            ap_enable_reg_pp2_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_420 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((eol_2_i_reg_264 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_329_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_i_fu_92 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_329_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((eol_2_i_reg_264 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op71_read_state6 == 1'b1)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((exitcond9_i_fu_318_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_529)) begin
        if ((brmerge_i_reg_429 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_i_phi_fu_244_p4 = eol_reg_217;
        end else if ((brmerge_i_reg_429 == 1'd0)) begin
...
always @ (*) begin
    if (((eol_2_i_reg_264 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    if (((exitcond_i_reg_420 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_264 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_i_reg_429 == 1'd0) & (exitcond_i_reg_420 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
        src_axis_TDATA_blk_n = AXI_video_strm_V_data_V_0_state[1'd0];
    end else begin
        src_axis_TDATA_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_309_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_309_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign AXI_video_strm_V_data_V_0_vld_in = src_axis_TVALID;

assign AXI_video_strm_V_data_V_0_vld_out = AXI_video_strm_V_data_V_0_state[1'd0];

assign AXI_video_strm_V_dest_V_0_vld_in = src_axis_TVALID;
...
assign AXI_video_strm_V_last_V_0_vld_in = src_axis_TVALID;
...
assign AXI_video_strm_V_user_V_0_vld_in = src_axis_TVALID;
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((eol_2_i_reg_264 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((eol_2_i_reg_264 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_420 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)));
end

assign ap_block_state8_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_pp2_stage0_iter1 = ((eol_2_i_reg_264 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end

always @ (*) begin
    ap_condition_529 = ((exitcond_i_reg_420 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_239 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_252 = 'bx;

always @ (*) begin
    ap_predicate_op71_read_state6 = ((brmerge_i_reg_429 == 1'd0) & (exitcond_i_reg_420 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_i_fu_343_p2 = (sof_1_i_fu_92 | ap_phi_mux_eol_i_phi_fu_209_p4);

assign exitcond9_i_fu_318_p2 = ((t_V_reg_183 == rows_V_reg_381) ? 1'b1 : 1'b0);

assign exitcond_i_fu_329_p2 = ((t_V_18_reg_194 == cols_V_reg_386) ? 1'b1 : 1'b0);

assign i_V_fu_323_p2 = (t_V_reg_183 + 32'd1);

assign img_cols_V_out_din = img_cols_V_dout;

assign img_data_stream_0_V_din = ap_phi_mux_p_Val2_s_phi_fu_256_p4[7:0];

assign img_data_stream_1_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_256_p4[15:8]}};

assign img_data_stream_2_V_din = {{ap_phi_mux_p_Val2_s_phi_fu_256_p4[23:16]}};

assign img_rows_V_out_din = img_rows_V_dout;

assign j_V_fu_334_p2 = (t_V_18_reg_194 + 32'd1);

assign src_axis_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

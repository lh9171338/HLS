...
#ifndef __SeedFill2_Core_mueOg__HH__
#define __SeedFill2_Core_mueOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(SeedFill2_Core_mueOg) {
    ...
    SC_CTOR(SeedFill2_Core_mueOg):  ACMP_smul_su_U ("ACMP_smul_su_U") {

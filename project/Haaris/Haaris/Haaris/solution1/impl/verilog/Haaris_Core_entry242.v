...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (threshold_out_full_n == 1'b0) | (k_out_full_n == 1'b0) | (cols_out2_full_n == 1'b0) | (cols_out_full_n == 1'b0) | (rows_out1_full_n == 1'b0) | (rows_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (threshold_out_full_n == 1'b0) | (k_out_full_n == 1'b0) | (cols_out2_full_n == 1'b0) | (cols_out_full_n == 1'b0) | (rows_out1_full_n == 1'b0) | (rows_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (threshold_out_full_n == 1'b0) | (k_out_full_n == 1'b0) | (cols_out2_full_n == 1'b0) | (cols_out_full_n == 1'b0) | (rows_out1_full_n == 1'b0) | (rows_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
endmodule //Haaris_Core_entry242

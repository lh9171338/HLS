...
#ifndef __HoughCircles_CorelbW__HH__
#define __HoughCircles_CorelbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughCircles_CorelbW) {
    ...
    SC_CTOR(HoughCircles_CorelbW):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {

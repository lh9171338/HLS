...
#ifndef _Rotate_Core_dst_val_H_
#define _Rotate_Core_dst_val_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "Rotate_Core_dst_val_memcore.h"

SC_MODULE(Rotate_Core_dst_val) {
...
protected:
    ...
    Rotate_Core_dst_val_memcore* Rotate_Core_dst_val_memcore_U;
...
public:
    ~Rotate_Core_dst_val();
    SC_CTOR(Rotate_Core_dst_val) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        Rotate_Core_dst_val_memcore_U = new Rotate_Core_dst_val_memcore("Rotate_Core_dst_val_memcore_U");
        Rotate_Core_dst_val_memcore_U->clk      ( clk );
        Rotate_Core_dst_val_memcore_U->reset    ( reset );
        Rotate_Core_dst_val_memcore_U->ce0      ( i_ce0 );
        Rotate_Core_dst_val_memcore_U->we0      ( i_we0 );
        Rotate_Core_dst_val_memcore_U->address0 ( memcore_iaddr );
        Rotate_Core_dst_val_memcore_U->d0       ( i_d0 );
        Rotate_Core_dst_val_memcore_U->q0       ( i_q0 );

        Rotate_Core_dst_val_memcore_U->ce1      ( t_ce0 );
        Rotate_Core_dst_val_memcore_U->we1      ( t_we0 );
        Rotate_Core_dst_val_memcore_U->address1 ( memcore_taddr );
        Rotate_Core_dst_val_memcore_U->d1       ( t_d0 );
        Rotate_Core_dst_val_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "Rotate_Core_dst_val.trace");
            // ports

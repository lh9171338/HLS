...
architecture behav of HoughLines_Core is 
    ...
    signal lines_i_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal lines_t_q0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal Block_Mat_exit6_proc_U0_src_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit6_proc_U0_src_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit6_proc_U0_src_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit6_proc_U0_src_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit6_proc_U0_edge_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit6_proc_U0_edge_rows_out_write : STD_LOGIC;
    signal Block_Mat_exit6_proc_U0_edge_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit6_proc_U0_edge_cols_out_write : STD_LOGIC;
    signal Block_Mat_exit6_proc_U0_dst_rows_V_out_din : STD_LOGIC_VECTOR (0 downto 0);
    signal Block_Mat_exit6_proc_U0_dst_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit6_proc_U0_dst_cols_V_out_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Block_Mat_exit6_proc_U0_dst_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit6_proc_U0_thresh_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit6_proc_U0_thresh_out_write : STD_LOGIC;
    ...
    signal Mat2Array2D_U0_array_val_address0 : STD_LOGIC_VECTOR (16 downto 0);
    signal Mat2Array2D_U0_array_val_ce0 : STD_LOGIC;
    signal Mat2Array2D_U0_array_val_we0 : STD_LOGIC;
    signal Mat2Array2D_U0_array_val_d0 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_channel_done_edge_val : STD_LOGIC;
    signal Mat2Array2D_U0_array_val_full_n : STD_LOGIC;
    signal HoughLinesStandard_U0_ap_start : STD_LOGIC;
    signal HoughLinesStandard_U0_ap_done : STD_LOGIC;
    signal HoughLinesStandard_U0_ap_continue : STD_LOGIC;
    signal HoughLinesStandard_U0_ap_idle : STD_LOGIC;
    signal HoughLinesStandard_U0_ap_ready : STD_LOGIC;
    signal HoughLinesStandard_U0_edge_val_address0 : STD_LOGIC_VECTOR (16 downto 0);
    signal HoughLinesStandard_U0_edge_val_ce0 : STD_LOGIC;
    signal HoughLinesStandard_U0_edge_rows_read : STD_LOGIC;
    signal HoughLinesStandard_U0_edge_cols_read : STD_LOGIC;
    signal HoughLinesStandard_U0_threshold_read : STD_LOGIC;
    signal HoughLinesStandard_U0_lines_address0 : STD_LOGIC_VECTOR (6 downto 0);
    signal HoughLinesStandard_U0_lines_ce0 : STD_LOGIC;
    signal HoughLinesStandard_U0_lines_we0 : STD_LOGIC;
    signal HoughLinesStandard_U0_lines_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal HoughLinesStandard_U0_lines_address1 : STD_LOGIC_VECTOR (6 downto 0);
    signal HoughLinesStandard_U0_lines_ce1 : STD_LOGIC;
    signal HoughLinesStandard_U0_lines_we1 : STD_LOGIC;
    signal HoughLinesStandard_U0_lines_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_channel_done_lines : STD_LOGIC;
    signal HoughLinesStandard_U0_lines_full_n : STD_LOGIC;
    ...
    signal Array2Mat_U0_fb_address0 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal Array2Mat_U0_img_data_stream_0_V_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Array2Mat_U0_img_data_stream_0_V_write : STD_LOGIC;
    signal Array2Mat_U0_img_data_stream_1_V_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Array2Mat_U0_img_data_stream_1_V_write : STD_LOGIC;
    signal Array2Mat_U0_img_rows_V_out_din : STD_LOGIC_VECTOR (0 downto 0);
    signal Array2Mat_U0_img_rows_V_out_write : STD_LOGIC;
    signal Array2Mat_U0_img_cols_V_out_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal lines_i_full_n : STD_LOGIC;
    signal lines_t_empty_n : STD_LOGIC;
    ...
    signal dst_rows_V_c_dout : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal src_rows_V_c18_full_n : STD_LOGIC;
    signal src_rows_V_c18_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal src_rows_V_c18_empty_n : STD_LOGIC;
    signal src_cols_V_c19_full_n : STD_LOGIC;
    signal src_cols_V_c19_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal src_cols_V_c19_empty_n : STD_LOGIC;
    ...
    signal dst_data_stream_1_V_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal dst_data_stream_1_V_empty_n : STD_LOGIC;
    signal dst_rows_V_c20_full_n : STD_LOGIC;
    signal dst_rows_V_c20_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal dst_rows_V_c20_empty_n : STD_LOGIC;
    signal dst_cols_V_c21_full_n : STD_LOGIC;
    signal dst_cols_V_c21_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal dst_cols_V_c21_empty_n : STD_LOGIC;
    ...
    signal HoughLinesStandard_U0_start_full_n : STD_LOGIC;
    signal HoughLinesStandard_U0_start_write : STD_LOGIC;
    ...
    port (
        ...
        array_val_address0 : OUT STD_LOGIC_VECTOR (16 downto 0);
        array_val_ce0 : OUT STD_LOGIC;
        array_val_we0 : OUT STD_LOGIC;
        array_val_d0 : OUT STD_LOGIC_VECTOR (7 downto 0) );
    end component;


    component HoughLinesStandard IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    port (
        ...
        img_rows_V_dout : IN STD_LOGIC_VECTOR (0 downto 0);
        img_rows_V_empty_n : IN STD_LOGIC;
        img_rows_V_read : OUT STD_LOGIC;
        img_cols_V_dout : IN STD_LOGIC_VECTOR (7 downto 0);
        img_cols_V_empty_n : IN STD_LOGIC;
        img_cols_V_read : OUT STD_LOGIC;
        img_data_stream_0_V_din : OUT STD_LOGIC_VECTOR (15 downto 0);
        img_data_stream_0_V_full_n : IN STD_LOGIC;
        img_data_stream_0_V_write : OUT STD_LOGIC;
        img_data_stream_1_V_din : OUT STD_LOGIC_VECTOR (15 downto 0);
        img_data_stream_1_V_full_n : IN STD_LOGIC;
        img_data_stream_1_V_write : OUT STD_LOGIC;
        img_rows_V_out_din : OUT STD_LOGIC_VECTOR (0 downto 0);
        img_rows_V_out_full_n : IN STD_LOGIC;
        img_rows_V_out_write : OUT STD_LOGIC;
        img_cols_V_out_din : OUT STD_LOGIC_VECTOR (7 downto 0);
        img_cols_V_out_full_n : IN STD_LOGIC;
        img_cols_V_out_write : OUT STD_LOGIC );
    end component;
    ...
    port (
        ...
        img_cols_V_empty_n : IN STD_LOGIC;
        img_cols_V_read : OUT STD_LOGIC;
        img_data_stream_0_V_dout : IN STD_LOGIC_VECTOR (15 downto 0);
        img_data_stream_0_V_empty_n : IN STD_LOGIC;
        img_data_stream_0_V_read : OUT STD_LOGIC;
        img_data_stream_1_V_dout : IN STD_LOGIC_VECTOR (15 downto 0);
    ...
    component HoughLines_Core_etde IS
    generic (
        DataWidth : INTEGER;
    ...
    component HoughLines_Core_ludo IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component start_for_Mat2Arrvdy IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component HoughLines_Core_ctrl_s_axi IS
    generic (
...
begin
    HoughLines_Core_ctrl_s_axi_U : component HoughLines_Core_ctrl_s_axi
    generic map (
    ...
    edge_val_U : component HoughLines_Core_etde
    generic map (
        DataWidth => 8,
        AddressRange => 76800,
        AddressWidth => 17)
    ...
    lines_U : component HoughLines_Core_ludo
    generic map (
        DataWidth => 32,
        AddressRange => 100,
        AddressWidth => 7)
    ...
    HoughLinesStandard_U0 : component HoughLinesStandard
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    edge_rows_c_U : component fifo_w32_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    edge_cols_c_U : component fifo_w32_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dst_rows_V_c_U : component fifo_w1_d5_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dst_cols_V_c_U : component fifo_w8_d5_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_rows_V_c18_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_cols_V_c19_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dst_data_stream_1_V_U : component fifo_w16_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dst_rows_V_c20_U : component fifo_w1_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dst_cols_V_c21_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Mat2Arrvdy_U : component start_for_Mat2Arrvdy
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = Block_Mat_exit6_proc_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                Block_Mat_exit6_proc_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit6_proc_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Array2Mat_U0_ap_start <= lines_t_empty_n;
    ...
    HoughLinesStandard_U0_ap_continue <= lines_i_full_n;
    HoughLinesStandard_U0_ap_start <= edge_val_t_empty_n;
    HoughLinesStandard_U0_lines_full_n <= lines_i_full_n;
    ...
    Mat2Array2D_U0_array_val_full_n <= edge_val_i_full_n;
    ...
    ap_channel_done_lines <= HoughLinesStandard_U0_ap_done;
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= ((lines_t_empty_n xor ap_const_logic_1) and (edge_val_t_empty_n xor ap_const_logic_1) and Mat2Array2D_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and HoughLinesStandard_U0_ap_idle and Block_Mat_exit6_proc_U0_ap_idle and Array2Mat_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);

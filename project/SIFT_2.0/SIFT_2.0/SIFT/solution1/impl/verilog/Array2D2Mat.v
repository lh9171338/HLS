...
reg   [5:0] i_reg_181;
wire   [13:0] tmp_412_cast_fu_147_p1;
reg   [13:0] tmp_412_cast_reg_186;
...
wire   [63:0] tmp_413_cast_fu_172_p1;
reg    ap_block_pp0_stage0_01001;
wire   [12:0] tmp_411_fu_139_p3;
wire   [13:0] tmp_1681_i_cast_fu_163_p1;
wire   [13:0] tmp_413_fu_167_p2;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (((exitcond1_fu_127_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_412_cast_reg_186[12 : 7] <= tmp_412_cast_fu_147_p1[12 : 7];
    end
end
...
assign arr_val_address0 = tmp_413_cast_fu_172_p1;

assign exitcond1_fu_127_p2 = ((i_i_reg_105 == 6'd32) ? 1'b1 : 1'b0);

assign exitcond_fu_151_p2 = ((j_i_reg_116 == 8'd128) ? 1'b1 : 1'b0);

assign i_fu_133_p2 = (i_i_reg_105 + 6'd1);
...
assign mat_rows_V_din = 7'd32;

assign start_out = real_start;

assign tmp_1681_i_cast_fu_163_p1 = j_i_reg_116;

assign tmp_411_fu_139_p3 = {{i_i_reg_105}, {7'd0}};

assign tmp_412_cast_fu_147_p1 = tmp_411_fu_139_p3;

assign tmp_413_cast_fu_172_p1 = tmp_413_fu_167_p2;

assign tmp_413_fu_167_p2 = (tmp_412_cast_reg_186 + tmp_1681_i_cast_fu_163_p1);

always @ (posedge ap_clk) begin
    tmp_412_cast_reg_186[6:0] <= 7'b0000000;
    tmp_412_cast_reg_186[13] <= 1'b0;
end

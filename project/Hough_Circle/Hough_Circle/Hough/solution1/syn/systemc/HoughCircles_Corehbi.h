...
#ifndef __HoughCircles_Corehbi__HH__
#define __HoughCircles_Corehbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughCircles_Corehbi) {
    ...
    SC_CTOR(HoughCircles_Corehbi):  simcore_mac_2_U ("simcore_mac_2_U") {

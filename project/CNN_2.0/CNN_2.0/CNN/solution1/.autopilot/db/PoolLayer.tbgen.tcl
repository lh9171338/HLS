...
set C_modelName {PoolLayer}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_val_V int 32 regular {array 3456 { 1 3 } 1 1 }  }
	{ poollayer_output_val_V int 32 regular {array 864 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ input_val_V_address0 sc_out sc_lv 12 signal 0 } 
	{ input_val_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ input_val_V_q0 sc_in sc_lv 32 signal 0 } 
	{ poollayer_output_val_V_address0 sc_out sc_lv 10 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_val_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "input_val_V", "role": "address0" }} , 
 	...
 	{ "name": "poollayer_output_val_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "poollayer_output_val_V", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "input_val_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_Conv9_fu_155", "Port" : "src_val_V"}]},
			{"Name" : "poollayer_output_val_V", "Type" : "Memory", "Direction" : "O"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.p_temp_val_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Conv9_fu_155", "Parent" : "0", "Child" : ["3", "4"],
		"CDFG" : "Conv9",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Conv9_fu_155.LineBuffer_val_1_V_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Conv9_fu_155.CNN_Core_am_addmuxdS_U102", "Parent" : "2"}]}
...
set Spec2ImplPortList { 
	input_val_V { ap_memory {  { input_val_V_address0 mem_address 1 12 }  { input_val_V_ce0 mem_ce 1 1 }  { input_val_V_q0 mem_dout 0 32 } } }
	poollayer_output_val_V { ap_memory {  { poollayer_output_val_V_address0 mem_address 1 10 }  { poollayer_output_val_V_ce0 mem_ce 1 1 }  { poollayer_output_val_V_we0 mem_we 1 1 }  { poollayer_output_val_V_d0 mem_din 1 32 } } }
}

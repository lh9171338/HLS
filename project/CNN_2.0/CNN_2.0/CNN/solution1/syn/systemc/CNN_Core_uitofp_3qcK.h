...
#ifndef __CNN_Core_uitofp_3qcK__HH__
#define __CNN_Core_uitofp_3qcK__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(CNN_Core_uitofp_3qcK) {
    ...
    SC_CTOR(CNN_Core_uitofp_3qcK):  ACMP_uitofp_U ("ACMP_uitofp_U") {

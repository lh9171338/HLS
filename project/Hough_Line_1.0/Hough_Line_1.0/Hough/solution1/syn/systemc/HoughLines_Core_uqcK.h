...
#ifndef __HoughLines_Core_uqcK__HH__
#define __HoughLines_Core_uqcK__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughLines_Core_uqcK) {
    ...
    SC_CTOR(HoughLines_Core_uqcK):  ACMP_uitofp_U ("ACMP_uitofp_U") {

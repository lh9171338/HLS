...
set C_modelArgList {
	...
	{ arr_val int 8 regular {array 250000 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ arr_val_address0 sc_out sc_lv 18 signal 3 } 
...
set Spec2ImplPortList { 
	...
	arr_val { ap_memory {  { arr_val_address0 mem_address 1 18 }  { arr_val_ce0 mem_ce 1 1 }  { arr_val_we0 mem_we 1 1 }  { arr_val_d0 mem_din 1 8 } } }

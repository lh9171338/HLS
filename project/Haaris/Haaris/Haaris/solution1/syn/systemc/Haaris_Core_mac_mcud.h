...
#ifndef __Haaris_Core_mac_mcud__HH__
#define __Haaris_Core_mac_mcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mcud) {
    ...
    SC_CTOR(Haaris_Core_mac_mcud):  simcore_mac_0_U ("simcore_mac_0_U") {

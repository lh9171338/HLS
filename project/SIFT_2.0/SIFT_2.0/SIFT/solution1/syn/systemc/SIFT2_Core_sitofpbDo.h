...
#ifndef __SIFT2_Core_sitofpbDo__HH__
#define __SIFT2_Core_sitofpbDo__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(SIFT2_Core_sitofpbDo) {
    ...
    SC_CTOR(SIFT2_Core_sitofpbDo):  ACMP_sitofp_U ("ACMP_sitofp_U") {

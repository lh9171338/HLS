...
#ifndef __adjustLocalExtrem2iS_H__
#define __adjustLocalExtrem2iS_H__
...
struct adjustLocalExtrem2iS_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(adjustLocalExtrem2iS_ram) {
...
SC_MODULE(adjustLocalExtrem2iS) {
...
adjustLocalExtrem2iS_ram* meminst;


SC_CTOR(adjustLocalExtrem2iS) {
meminst = new adjustLocalExtrem2iS_ram("adjustLocalExtrem2iS_ram");

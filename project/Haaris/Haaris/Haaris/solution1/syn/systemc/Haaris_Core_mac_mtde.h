...
#ifndef __Haaris_Core_mac_mtde__HH__
#define __Haaris_Core_mac_mtde__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mtde) {
    ...
    SC_CTOR(Haaris_Core_mac_mtde):  simcore_mac_11_U ("simcore_mac_11_U") {

...
#ifndef __sin_or_cos_float_bgk_H__
#define __sin_or_cos_float_bgk_H__
...
struct sin_or_cos_float_bgk_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sin_or_cos_float_bgk_ram) {
...
SC_MODULE(sin_or_cos_float_bgk) {
...
sin_or_cos_float_bgk_ram* meminst;


SC_CTOR(sin_or_cos_float_bgk) {
meminst = new sin_or_cos_float_bgk_ram("sin_or_cos_float_bgk_ram");

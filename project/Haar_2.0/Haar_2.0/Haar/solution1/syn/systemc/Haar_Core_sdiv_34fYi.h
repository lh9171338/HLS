...
#ifndef __Haar_Core_sdiv_34fYi__HH__
#define __Haar_Core_sdiv_34fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haar_Core_sdiv_34fYi) {
    ...
    ACMP_sdiv_seq<ID, 38, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(Haar_Core_sdiv_34fYi):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {

...
Mat2AXIvideo::Mat2AXIvideo(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( AXI_video_strm_V_id_V_1_ack_in );
    sensitive << ( AXI_video_strm_V_dest_V_1_ack_in );
    sensitive << ( exitcond4_i_fu_165_p2 );
    ...
    SC_METHOD(thread_exitcond4_i_fu_165_p2);
    sensitive << ( AXI_video_strm_V_data_V_1_ack_in );
    sensitive << ( AXI_video_strm_V_keep_V_1_ack_in );
    sensitive << ( AXI_video_strm_V_strb_V_1_ack_in );
    sensitive << ( AXI_video_strm_V_user_V_1_ack_in );
    ...
    sc_trace(mVcdFile, exitcond4_i_fu_165_p2, "exitcond4_i_fu_165_p2");
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(exitcond4_i_fu_165_p2.read(), ap_const_lv1_1) && 
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_boolean_0, ap_block_pp0_stage0_subdone.read()) && 
            ...
            ap_enable_reg_pp0_iter0 = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(exitcond4_i_fu_165_p2.read(), ap_const_lv1_0) && 
                    esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
...
void Mat2AXIvideo::thread_exitcond4_i_fu_165_p2() {
    exitcond4_i_fu_165_p2 = (!t_V_reg_128.read().is_01() || !rows_V_reg_212.read().is_01())? sc_lv<1>(): sc_lv<1>(t_V_reg_128.read() == rows_V_reg_212.read());
}
...
void Mat2AXIvideo::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((!(esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_data_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_dest_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_id_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_last_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_user_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_strb_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_keep_V_1_ack_in.read())) && esl_seteq<1,1,1>(exitcond4_i_fu_165_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((!(esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_data_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_dest_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_id_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_last_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_user_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_strb_V_1_ack_in.read()) || esl_seteq<1,1,1>(ap_const_logic_0, AXI_video_strm_V_keep_V_1_ack_in.read())) && esl_seteq<1,1,1>(exitcond4_i_fu_165_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {

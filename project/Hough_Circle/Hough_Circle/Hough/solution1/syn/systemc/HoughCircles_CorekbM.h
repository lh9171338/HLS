...
#ifndef __HoughCircles_CorekbM__HH__
#define __HoughCircles_CorekbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughCircles_CorekbM) {
    ...
    SC_CTOR(HoughCircles_CorekbM):  simcore_mac_5_U ("simcore_mac_5_U") {

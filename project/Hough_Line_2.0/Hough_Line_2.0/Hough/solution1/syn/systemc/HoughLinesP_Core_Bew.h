...
#ifndef __HoughLinesP_Core_Bew__HH__
#define __HoughLinesP_Core_Bew__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughLinesP_Core_Bew) {
    ...
    SC_CTOR(HoughLinesP_Core_Bew):  ACMP_sitofp_U ("ACMP_sitofp_U") {

...
#ifndef _Filter2D_Core_srcvdy_H_
#define _Filter2D_Core_srcvdy_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "Filter2D_Core_srcvdy_memcore.h"

SC_MODULE(Filter2D_Core_srcvdy) {
    static const unsigned int DataWidth    = 8;
    static const unsigned int AddressRange = 32;
    static const unsigned int AddressWidth = 16;
...
protected:
    ...
    Filter2D_Core_srcvdy_memcore* Filter2D_Core_srcvdy_memcore_U;
...
public:
    ...
    SC_CTOR(Filter2D_Core_srcvdy) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        Filter2D_Core_srcvdy_memcore_U = new Filter2D_Core_srcvdy_memcore("Filter2D_Core_srcvdy_memcore_U");
        Filter2D_Core_srcvdy_memcore_U->clk      ( clk );
        Filter2D_Core_srcvdy_memcore_U->reset    ( reset );
        Filter2D_Core_srcvdy_memcore_U->ce0      ( i_ce0 );
        Filter2D_Core_srcvdy_memcore_U->we0      ( i_we0 );
        Filter2D_Core_srcvdy_memcore_U->address0 ( memcore_iaddr );
        Filter2D_Core_srcvdy_memcore_U->d0       ( i_d0 );
        Filter2D_Core_srcvdy_memcore_U->q0       ( i_q0 );

        Filter2D_Core_srcvdy_memcore_U->ce1      ( t_ce0 );
        Filter2D_Core_srcvdy_memcore_U->we1      ( t_we0 );
        Filter2D_Core_srcvdy_memcore_U->address1 ( memcore_taddr );
        Filter2D_Core_srcvdy_memcore_U->d1       ( t_d0 );
        Filter2D_Core_srcvdy_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "Filter2D_Core_srcvdy.trace");
            // ports

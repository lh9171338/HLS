...
#ifndef __SIFT2_Core_mac_muFfa__HH__
#define __SIFT2_Core_mac_muFfa__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(SIFT2_Core_mac_muFfa) {
    ...
    SC_CTOR(SIFT2_Core_mac_muFfa):  simcore_mac_0_U ("simcore_mac_0_U") {

...
#ifndef __HoughCircles_CorejbC__HH__
#define __HoughCircles_CorejbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughCircles_CorejbC) {
    ...
    SC_CTOR(HoughCircles_CorejbC):  simcore_mac_4_U ("simcore_mac_4_U") {

...
entity pow_generic_floatyd2_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of pow_generic_floatyd2_rom is 
...
entity pow_generic_floatyd2 is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of pow_generic_floatyd2 is
    component pow_generic_floatyd2_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pow_generic_floatyd2_rom_U :  component pow_generic_floatyd2_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

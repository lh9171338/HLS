...
#ifndef _HoughLinesP_Core_HH_
#define _HoughLinesP_Core_HH_
...
#include "HoughLinesP_Core_Gfk.h"
#include "HoughLinesP_Core_Hfu.h"
...
#include "start_for_Mat2AXIJfO.h"
#include "HoughLinesP_Core_ctrl_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_CTRL_ADDR_WIDTH = 6,
         unsigned int C_S_AXI_CTRL_DATA_WIDTH = 32>
struct HoughLinesP_Core : public sc_module {
    ...
    // Module declarations
    HoughLinesP_Core(sc_module_name name);
    SC_HAS_PROCESS(HoughLinesP_Core);
    ...
    HoughLinesP_Core_ctrl_s_axi<C_S_AXI_CTRL_ADDR_WIDTH,C_S_AXI_CTRL_DATA_WIDTH>* HoughLinesP_Core_ctrl_s_axi_U;
    HoughLinesP_Core_Gfk* edge_val_U;
    HoughLinesP_Core_Hfu* lines_val_U;
    ...
    sc_signal< sc_lv<32> > lineGap;
    sc_signal< sc_lv<8> > edge_val_i_q0;
    sc_signal< sc_lv<8> > edge_val_t_q0;
    sc_signal< sc_lv<16> > lines_val_i_q0;
    sc_signal< sc_lv<16> > lines_val_t_q0;
    ...
    sc_signal< sc_lv<32> > Block_Mat_exit8_proc_U0_src_rows_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_src_rows_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit8_proc_U0_src_cols_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_src_cols_V_out_write;
    sc_signal< sc_lv<4> > Block_Mat_exit8_proc_U0_lines_rows_out_din;
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_lines_rows_out_write;
    sc_signal< sc_lv<8> > Block_Mat_exit8_proc_U0_lines_cols_out_din;
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_lines_cols_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit8_proc_U0_thresh_out_din;
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_thresh_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit8_proc_U0_lineGap_out_din;
    sc_signal< sc_logic > Block_Mat_exit8_proc_U0_lineGap_out_write;
    ...
    sc_signal< sc_logic > HoughLinesProbabilis_U0_ap_start;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_ap_done;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_ap_continue;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_ap_idle;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_ap_ready;
    sc_signal< sc_lv<17> > HoughLinesProbabilis_U0_edge_val_address0;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_edge_val_ce0;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_edge_rows_read;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_edge_cols_read;
    sc_signal< sc_lv<9> > HoughLinesProbabilis_U0_lines_val_address0;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_lines_val_ce0;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_lines_val_we0;
    sc_signal< sc_lv<16> > HoughLinesProbabilis_U0_lines_val_d0;
    sc_signal< sc_lv<9> > HoughLinesProbabilis_U0_lines_val_address1;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_lines_val_ce1;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_lines_val_we1;
    sc_signal< sc_lv<16> > HoughLinesProbabilis_U0_lines_val_d1;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_lines_rows_read;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_lines_cols_read;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_threshold_read;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_lineGap_read;
    sc_signal< sc_lv<4> > HoughLinesProbabilis_U0_lines_rows_out_din;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_lines_rows_out_write;
    sc_signal< sc_lv<8> > HoughLinesProbabilis_U0_lines_cols_out_din;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_lines_cols_out_write;
    sc_signal< sc_logic > ap_channel_done_lines_val;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_lines_val_full_n;
    ...
    sc_signal< sc_logic > lines_val_i_full_n;
    sc_signal< sc_logic > lines_val_t_empty_n;
    ...
    sc_signal< sc_logic > lines_rows_c_full_n;
    sc_signal< sc_lv<4> > lines_rows_c_dout;
    sc_signal< sc_logic > lines_rows_c_empty_n;
    sc_signal< sc_logic > lines_cols_c_full_n;
    sc_signal< sc_lv<8> > lines_cols_c_dout;
    sc_signal< sc_logic > lines_cols_c_empty_n;
    sc_signal< sc_logic > thresh_c_full_n;
    sc_signal< sc_lv<32> > thresh_c_dout;
    sc_signal< sc_logic > thresh_c_empty_n;
    sc_signal< sc_logic > lineGap_c_full_n;
    sc_signal< sc_lv<32> > lineGap_c_dout;
    sc_signal< sc_logic > lineGap_c_empty_n;
    ...
    sc_signal< sc_logic > src_rows_V_c20_full_n;
    sc_signal< sc_lv<32> > src_rows_V_c20_dout;
    sc_signal< sc_logic > src_rows_V_c20_empty_n;
    sc_signal< sc_logic > src_cols_V_c21_full_n;
    sc_signal< sc_lv<32> > src_cols_V_c21_dout;
    sc_signal< sc_logic > src_cols_V_c21_empty_n;
    ...
    sc_signal< sc_logic > lines_rows_c22_full_n;
    sc_signal< sc_lv<4> > lines_rows_c22_dout;
    sc_signal< sc_logic > lines_rows_c22_empty_n;
    sc_signal< sc_logic > lines_cols_c23_full_n;
    sc_signal< sc_lv<8> > lines_cols_c23_dout;
    sc_signal< sc_logic > lines_cols_c23_empty_n;
    ...
    sc_signal< sc_lv<4> > dst_rows_V_c_dout;
    ...
    sc_signal< sc_logic > HoughLinesProbabilis_U0_start_full_n;
    sc_signal< sc_logic > HoughLinesProbabilis_U0_start_write;
    ...
    void thread_HoughLinesProbabilis_U0_ap_continue();
    void thread_HoughLinesProbabilis_U0_ap_start();
    void thread_HoughLinesProbabilis_U0_lines_val_full_n();
    void thread_HoughLinesProbabilis_U0_start_full_n();
    void thread_HoughLinesProbabilis_U0_start_write();
    ...
    void thread_ap_channel_done_lines_val();
    void thread_ap_done();
    void thread_ap_idle();

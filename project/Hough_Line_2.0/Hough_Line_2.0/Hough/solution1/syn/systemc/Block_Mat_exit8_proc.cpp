...
const sc_lv<8> Block_Mat_exit8_proc::ap_const_lv8_64 = "1100100";
...
Block_Mat_exit8_proc::Block_Mat_exit8_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_lineGap_out_blk_n);
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( lineGap_out_full_n );

    SC_METHOD(thread_lineGap_out_din);
    sensitive << ( ap_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( lineGap );
    ...
    SC_METHOD(thread_lineGap_out_write);
    sensitive << ( ap_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( src_rows_V_out_full_n );
    ...
    sc_trace(mVcdFile, lineGap, "(port)lineGap");
    ...
    sc_trace(mVcdFile, lineGap_out_din, "(port)lineGap_out_din");
    sc_trace(mVcdFile, lineGap_out_full_n, "(port)lineGap_out_full_n");
    sc_trace(mVcdFile, lineGap_out_write, "(port)lineGap_out_write");
#endif
    ...
    sc_trace(mVcdFile, lineGap_out_blk_n, "lineGap_out_blk_n");
...
void Block_Mat_exit8_proc::thread_lineGap_out_blk_n() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read())) {
        lineGap_out_blk_n = lineGap_out_full_n.read();
    } else {
        lineGap_out_blk_n = ap_const_logic_1;
    }
}

void Block_Mat_exit8_proc::thread_lineGap_out_din() {
    lineGap_out_din = lineGap.read();
}

void Block_Mat_exit8_proc::thread_lineGap_out_write() {
    if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lineGap_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(thresh_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_cols_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_rows_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_cols_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_rows_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void Block_Mat_exit8_proc::thread_lines_cols_out_blk_n() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read())) {
...
void Block_Mat_exit8_proc::thread_lines_cols_out_din() {
    lines_cols_out_din = ap_const_lv8_64;
}

void Block_Mat_exit8_proc::thread_lines_cols_out_write() {
    if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lineGap_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(thresh_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_cols_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_rows_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_cols_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_rows_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void Block_Mat_exit8_proc::thread_lines_rows_out_blk_n() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read())) {
...
void Block_Mat_exit8_proc::thread_lines_rows_out_din() {
    lines_rows_out_din = ap_const_lv4_4;
}

void Block_Mat_exit8_proc::thread_lines_rows_out_write() {
    if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lineGap_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(thresh_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_cols_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_rows_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_cols_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_rows_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void Block_Mat_exit8_proc::thread_src_cols_V_out_blk_n() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read())) {
...
void Block_Mat_exit8_proc::thread_src_cols_V_out_din() {
    src_cols_V_out_din = cols.read();
}

void Block_Mat_exit8_proc::thread_src_cols_V_out_write() {
    if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lineGap_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(thresh_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_cols_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_rows_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_cols_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_rows_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void Block_Mat_exit8_proc::thread_src_rows_V_out_blk_n() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read())) {
...
void Block_Mat_exit8_proc::thread_src_rows_V_out_din() {
    src_rows_V_out_din = rows.read();
}

void Block_Mat_exit8_proc::thread_src_rows_V_out_write() {
    if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lineGap_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(thresh_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_cols_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_rows_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_cols_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_rows_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
...
void Block_Mat_exit8_proc::thread_thresh_out_blk_n() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read())) {
...
void Block_Mat_exit8_proc::thread_thresh_out_din() {
    thresh_out_din = thresh.read();
}

void Block_Mat_exit8_proc::thread_thresh_out_write() {
    if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lineGap_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(thresh_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_cols_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(lines_rows_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_cols_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(src_rows_V_out_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {

...
#ifndef __sin_or_cos_float_bdk_H__
#define __sin_or_cos_float_bdk_H__
...
struct sin_or_cos_float_bdk_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sin_or_cos_float_bdk_ram) {
...
SC_MODULE(sin_or_cos_float_bdk) {
...
sin_or_cos_float_bdk_ram* meminst;


SC_CTOR(sin_or_cos_float_bdk) {
meminst = new sin_or_cos_float_bdk_ram("sin_or_cos_float_bdk_ram");

...
#ifndef __CNN_Core_am_addmuxdS__HH__
#define __CNN_Core_am_addmuxdS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(CNN_Core_am_addmuxdS) {
    ...
    SC_CTOR(CNN_Core_am_addmuxdS):  simcore_am_0_U ("simcore_am_0_U") {

...
set C_modelArgList {
	{ arr_val int 8 regular {array 65536 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ arr_val_address0 sc_out sc_lv 16 signal 0 } 
...
set Spec2ImplPortList { 
	arr_val { ap_memory {  { arr_val_address0 mem_address 1 16 }  { arr_val_ce0 mem_ce 1 1 }  { arr_val_q0 mem_dout 0 8 } } }

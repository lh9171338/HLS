...
#ifndef __Haaris_Core_mac_mncg__HH__
#define __Haaris_Core_mac_mncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mncg) {
    ...
    SC_CTOR(Haaris_Core_mac_mncg):  simcore_mac_5_U ("simcore_mac_5_U") {

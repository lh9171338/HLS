...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename dst_val \
    op interface \
    ports { dst_val_address0 { O 17 vector } dst_val_ce0 { O 1 bit } dst_val_we0 { O 1 bit } dst_val_d0 { O 8 vector } } \
} "
} else {

...
architecture behav of Filter2D_Core is 
    ...
    signal Block_Mat_exit5_proc_U0_sigma_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit5_proc_U0_sigma_out_write : STD_LOGIC;
    ...
    signal GaussianBlur_U0_src_val_address0 : STD_LOGIC_VECTOR (15 downto 0);
    signal GaussianBlur_U0_src_val_ce0 : STD_LOGIC;
    signal GaussianBlur_U0_src_rows_read : STD_LOGIC;
    signal GaussianBlur_U0_src_cols_read : STD_LOGIC;
    signal GaussianBlur_U0_dst_val_address0 : STD_LOGIC_VECTOR (15 downto 0);
    signal GaussianBlur_U0_dst_val_ce0 : STD_LOGIC;
    signal GaussianBlur_U0_dst_val_we0 : STD_LOGIC;
    signal GaussianBlur_U0_dst_val_d0 : STD_LOGIC_VECTOR (7 downto 0);
    signal GaussianBlur_U0_sigmaX_read : STD_LOGIC;
    signal GaussianBlur_U0_dst_rows_din : STD_LOGIC_VECTOR (31 downto 0);
    signal GaussianBlur_U0_dst_rows_write : STD_LOGIC;
    signal GaussianBlur_U0_dst_cols_din : STD_LOGIC_VECTOR (31 downto 0);
    signal GaussianBlur_U0_dst_cols_write : STD_LOGIC;
    signal ap_channel_done_dst_val : STD_LOGIC;
    signal GaussianBlur_U0_dst_val_full_n : STD_LOGIC;
    ...
    component Filter2D_Core_srcvdy IS
    generic (
        DataWidth : INTEGER;
    ...
    component Filter2D_Core_ctrl_s_axi IS
    generic (
...
begin
    Filter2D_Core_ctrl_s_axi_U : component Filter2D_Core_ctrl_s_axi
    generic map (
    ...
    src_val_U : component Filter2D_Core_srcvdy
    generic map (
        DataWidth => 8,
        AddressRange => 65536,
        AddressWidth => 16)
    ...
    dst_val_U : component Filter2D_Core_srcvdy
    generic map (
        DataWidth => 8,
        AddressRange => 65536,
        AddressWidth => 16)
    ...
    sigma_c_U : component fifo_w32_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dst_rows_c_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    dst_cols_c_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_dst_rows_V_c_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_dst_cols_V_c_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    GaussianBlur_U0_ap_continue <= dst_val_i_full_n;
    GaussianBlur_U0_ap_start <= src_val_t_empty_n;
    GaussianBlur_U0_dst_val_full_n <= dst_val_i_full_n;
    ...
    ap_channel_done_dst_val <= GaussianBlur_U0_ap_done;
    ap_channel_done_src_val <= Mat2Array2D_U0_ap_done;
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= ((dst_val_t_empty_n xor ap_const_logic_1) and (src_val_t_empty_n xor ap_const_logic_1) and Mat2Array2D_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and GaussianBlur_U0_ap_idle and Block_Mat_exit5_proc_U0_ap_idle and Array2D2Mat_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);

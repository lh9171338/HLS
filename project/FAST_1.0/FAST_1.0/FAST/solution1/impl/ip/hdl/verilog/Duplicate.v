...
reg   [31:0] t_V_4_reg_157;
reg   [31:0] rows_V_reg_190;
reg    ap_block_state1;
reg   [31:0] cols_V_reg_195;
wire   [0:0] exitcond1_i_fu_168_p2;
wire    ap_CS_fsm_state2;
wire   [31:0] i_V_fu_173_p2;
reg   [31:0] i_V_reg_204;
wire   [0:0] exitcond_i_fu_179_p2;
wire    ap_block_state3_pp0_stage0_iter0;
reg    ap_block_state4_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [31:0] j_V_fu_184_p2;
reg    ap_enable_reg_pp0_iter0;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg   [31:0] t_V_reg_146;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (exitcond1_i_fu_168_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((exitcond1_i_fu_168_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_179_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((exitcond_i_fu_179_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond1_i_fu_168_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((exitcond_i_reg_209 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond_i_reg_209 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_i_fu_179_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_i_fu_179_p2 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_i_reg_209 == 1'd0) & (dst2_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst2_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst2_data_stream_0_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst1_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst1_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst1_data_stream_0_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_i_reg_209 == 1'd0) & (dst2_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst2_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst2_data_stream_0_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst1_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst1_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst1_data_stream_0_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((exitcond_i_reg_209 == 1'd0) & (dst2_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst2_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst2_data_stream_0_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst1_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst1_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (dst1_data_stream_0_V_full_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (src_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (src_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_i_reg_209 == 1'd0) & (src_data_stream_0_V_empty_n == 1'b0)));
end
...
assign exitcond1_i_fu_168_p2 = ((t_V_reg_146 == rows_V_reg_190) ? 1'b1 : 1'b0);

assign exitcond_i_fu_179_p2 = ((t_V_4_reg_157 == cols_V_reg_195) ? 1'b1 : 1'b0);

assign i_V_fu_173_p2 = (t_V_reg_146 + 32'd1);

assign j_V_fu_184_p2 = (t_V_4_reg_157 + 32'd1);

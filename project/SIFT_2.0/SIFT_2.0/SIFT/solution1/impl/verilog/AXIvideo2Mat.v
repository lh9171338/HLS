...
reg   [0:0] axi_last_V8_i_reg_139;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state3;
reg   [7:0] axi_data_V6_i_reg_149;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond7_i_fu_295_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_fu_306_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond7_i_fu_295_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((exitcond7_i_fu_295_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_241 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_i_reg_379 == 1'd0) & (exitcond_i_reg_370 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
        src1_axis_TDATA_blk_n = AXI_video_strm_V_data_V_0_state[1'd0];
    end else begin
        src1_axis_TDATA_blk_n = 1'b1;
    end
end
...
assign AXI_video_strm_V_data_V_0_vld_in = src1_axis_TVALID;

assign AXI_video_strm_V_data_V_0_vld_out = AXI_video_strm_V_data_V_0_state[1'd0];

assign AXI_video_strm_V_dest_V_0_vld_in = src1_axis_TVALID;
...
assign AXI_video_strm_V_last_V_0_vld_in = src1_axis_TVALID;
...
assign AXI_video_strm_V_user_V_0_vld_in = src1_axis_TVALID;
...
assign exitcond7_i_fu_295_p2 = ((t_V_reg_159 == rows_V_reg_331) ? 1'b1 : 1'b0);

assign exitcond_i_fu_306_p2 = ((t_V_69_reg_170 == cols_V_reg_336) ? 1'b1 : 1'b0);
...
assign j_V_fu_311_p2 = (t_V_69_reg_170 + 32'd1);

assign src1_axis_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

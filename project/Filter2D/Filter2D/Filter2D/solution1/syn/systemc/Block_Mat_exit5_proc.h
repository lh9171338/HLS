...
#ifndef _Block_Mat_exit5_proc_HH_
#define _Block_Mat_exit5_proc_HH_
...
struct Block_Mat_exit5_proc : public sc_module {
    ...
    sc_out< sc_lv<32> > sigma_out_din;
    sc_in< sc_logic > sigma_out_full_n;
    sc_out< sc_logic > sigma_out_write;


    // Module declarations
    Block_Mat_exit5_proc(sc_module_name name);
    SC_HAS_PROCESS(Block_Mat_exit5_proc);
    ...
    sc_signal< sc_logic > sigma_out_blk_n;
    ...
    void thread_sigma_out_blk_n();
    void thread_sigma_out_din();
    void thread_sigma_out_write();

...
initial begin
    $readmemh("./HaarCascadeClassipcA_rom.dat", ram0);
    $readmemh("./HaarCascadeClassipcA_rom.dat", ram1);
    $readmemh("./HaarCascadeClassipcA_rom.dat", ram2);
end
...
parameter AddressRange = 32'd6282;
...
HaarCascadeClassipcA_rom HaarCascadeClassipcA_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

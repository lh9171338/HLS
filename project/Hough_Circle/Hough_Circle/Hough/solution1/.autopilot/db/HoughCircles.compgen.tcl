...
set out_width 17
set exp i0*i1+i2
set arg_lists {i0 {16 1 +} i1 {10 0 +} m {17 1 +} i2 {16 0 +} p {17 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 184
set hasByteEnable 0
set MemName HoughCircles_masksc4
...
set ID 185
set hasByteEnable 0
set MemName HoughCircles_one_tde
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 53
set AddrRange 64
...
set ID 186
set hasByteEnable 0
set MemName HoughCircles_accum
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 77924
...
set ID 187
set hasByteEnable 0
set MemName HoughCircles_distudo
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 321
...
set ID 188
set hasByteEnable 0
set MemName HoughCircles_pt_bvdy
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 31
set AddrRange 76800
...
set ID 189
set hasByteEnable 0
set MemName HoughCircles_centxdS
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 77924
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename edge_val \
    op interface \
    ports { edge_val_address0 { O 17 vector } edge_val_ce0 { O 1 bit } edge_val_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'edge_val'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename dx_val \
    op interface \
    ports { dx_val_address0 { O 17 vector } dx_val_ce0 { O 1 bit } dx_val_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'dx_val'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename dy_val \
    op interface \
    ports { dy_val_address0 { O 17 vector } dy_val_ce0 { O 1 bit } dy_val_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'dy_val'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir IO \
    corename circles_val \
    op interface \
    ports { circles_val_address0 { O 9 vector } circles_val_ce0 { O 1 bit } circles_val_we0 { O 1 bit } circles_val_d0 { O 16 vector } circles_val_q0 { I 16 vector } circles_val_address1 { O 9 vector } circles_val_ce1 { O 1 bit } circles_val_we1 { O 1 bit } circles_val_d1 { O 16 vector } circles_val_q1 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'circles_val'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_edge_rows \
    op interface \
    ports { edge_rows_dout { I 32 vector } edge_rows_empty_n { I 1 bit } edge_rows_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_edge_cols \
    op interface \
    ports { edge_cols_dout { I 32 vector } edge_cols_empty_n { I 1 bit } edge_cols_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_circles_rows \
    op interface \
    ports { circles_rows_dout { I 3 vector } circles_rows_empty_n { I 1 bit } circles_rows_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_circles_cols \
    op interface \
    ports { circles_cols_dout { I 8 vector } circles_cols_empty_n { I 1 bit } circles_cols_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_acc_threshold \
    op interface \
    ports { acc_threshold_dout { I 32 vector } acc_threshold_empty_n { I 1 bit } acc_threshold_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { min_dist_dout { I 32 vector } min_dist_empty_n { I 1 bit } min_dist_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { min_radius_dout { I 32 vector } min_radius_empty_n { I 1 bit } min_radius_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { max_radius_dout { I 32 vector } max_radius_empty_n { I 1 bit } max_radius_read { O 1 bit } } \
} "
}

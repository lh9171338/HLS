...
localparam
    ...
    ADDR_THREHOLD_DATA_0 = 6'h20,
    ADDR_THREHOLD_CTRL   = 6'h24,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_THREHOLD_DATA_0)
            int_threhold[7:0] <= (WDATA[31:0] & wmask) | (int_threhold[7:0] & ~wmask);
    end
end

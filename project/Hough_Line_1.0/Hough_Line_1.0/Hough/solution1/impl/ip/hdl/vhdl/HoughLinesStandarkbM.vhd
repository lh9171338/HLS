...
entity HoughLinesStandarkbM_rom is 
    generic(
             DWIDTH     : integer := 24; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of HoughLinesStandarkbM_rom is 
...
entity HoughLinesStandarkbM is
    generic (
...
architecture arch of HoughLinesStandarkbM is
    component HoughLinesStandarkbM_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    HoughLinesStandarkbM_rom_U :  component HoughLinesStandarkbM_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

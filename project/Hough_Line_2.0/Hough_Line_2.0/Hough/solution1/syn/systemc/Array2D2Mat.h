...
struct Array2D2Mat : public sc_module {
    ...
    sc_signal< sc_lv<1> > tmp_271_i_reg_226;
    sc_signal< sc_logic > mat_rows_V_blk_n;
    sc_signal< sc_logic > mat_cols_V_blk_n;
    sc_signal< sc_lv<7> > j_i_reg_140;
    sc_signal< sc_lv<4> > arr_rows_read_reg_202;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<8> > arr_cols_read_reg_207;
    sc_signal< sc_lv<10> > next_mul_fu_151_p2;
    sc_signal< sc_lv<10> > next_mul_reg_212;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<1> > tmp_i_fu_161_p2;
    sc_signal< sc_lv<3> > i_fu_166_p2;
    sc_signal< sc_lv<3> > i_reg_221;
    sc_signal< sc_lv<1> > tmp_271_i_fu_176_p2;
    ...
    sc_signal< sc_lv<64> > tmp_74_cast_fu_197_p1;
    sc_signal< bool > ap_block_pp0_stage0_01001;
    sc_signal< sc_lv<4> > i_cast_cast_i_fu_157_p1;
    sc_signal< sc_lv<8> > j_cast_cast_i_fu_172_p1;
    sc_signal< sc_lv<10> > tmp_272_i_cast_fu_187_p1;
    sc_signal< sc_lv<10> > tmp_s_fu_191_p2;
    ...
    void thread_tmp_271_i_fu_176_p2();
    void thread_tmp_272_i_cast_fu_187_p1();

...
#ifndef _Duplicate182_HH_
#define _Duplicate182_HH_
...
struct Duplicate182 : public sc_module {
    ...
    // Module declarations
    Duplicate182(sc_module_name name);
    SC_HAS_PROCESS(Duplicate182);
    ...
    void thread_exitcond4_i_fu_110_p2();

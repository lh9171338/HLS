...
set C_modelArgList {
	...
	{ arr_rows int 17 regular {fifo 0}  }
	{ arr_cols int 17 regular {fifo 0}  }
	{ mat_data_stream_V int 8 regular {fifo 1 volatile }  }
	{ mat_rows_V int 17 regular {fifo 1}  }
	{ mat_cols_V int 17 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "arr_val", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "arr_rows", "interface" : "fifo", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "arr_cols", "interface" : "fifo", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "mat_data_stream_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "mat_rows_V", "interface" : "fifo", "bitwidth" : 17, "direction" : "WRITEONLY"} , 
 	{ "Name" : "mat_cols_V", "interface" : "fifo", "bitwidth" : 17, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arr_rows_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "arr_rows", "role": "dout" }} , 
 	...
 	{ "name": "arr_cols_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "arr_cols", "role": "dout" }} , 
 	...
 	{ "name": "mat_rows_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "mat_rows_V", "role": "din" }} , 
 	...
 	{ "name": "mat_cols_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "mat_cols_V", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	arr_rows { ap_fifo {  { arr_rows_dout fifo_data 0 17 }  { arr_rows_empty_n fifo_status 0 1 }  { arr_rows_read fifo_update 1 1 } } }
	arr_cols { ap_fifo {  { arr_cols_dout fifo_data 0 17 }  { arr_cols_empty_n fifo_status 0 1 }  { arr_cols_read fifo_update 1 1 } } }
	...
	mat_rows_V { ap_fifo {  { mat_rows_V_din fifo_data 1 17 }  { mat_rows_V_full_n fifo_status 0 1 }  { mat_rows_V_write fifo_update 1 1 } } }
	mat_cols_V { ap_fifo {  { mat_cols_V_din fifo_data 1 17 }  { mat_cols_V_full_n fifo_status 0 1 }  { mat_cols_V_write fifo_update 1 1 } } }
}

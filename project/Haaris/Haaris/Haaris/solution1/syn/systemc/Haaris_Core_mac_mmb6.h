...
#ifndef __Haaris_Core_mac_mmb6__HH__
#define __Haaris_Core_mac_mmb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mmb6) {
    ...
    SC_CTOR(Haaris_Core_mac_mmb6):  simcore_mac_4_U ("simcore_mac_4_U") {

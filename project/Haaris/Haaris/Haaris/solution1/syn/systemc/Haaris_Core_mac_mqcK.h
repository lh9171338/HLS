...
#ifndef __Haaris_Core_mac_mqcK__HH__
#define __Haaris_Core_mac_mqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mqcK) {
    ...
    SC_CTOR(Haaris_Core_mac_mqcK):  simcore_mac_8_U ("simcore_mac_8_U") {

...
#ifndef __Filter2D_Core_fcmfYi__HH__
#define __Filter2D_Core_fcmfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Filter2D_Core_fcmfYi) {
    ...
    SC_CTOR(Filter2D_Core_fcmfYi):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {

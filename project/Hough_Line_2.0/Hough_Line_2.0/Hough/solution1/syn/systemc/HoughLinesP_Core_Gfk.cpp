...
void HoughLinesP_Core_Gfk::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void HoughLinesP_Core_Gfk::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void HoughLinesP_Core_Gfk::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void HoughLinesP_Core_Gfk::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {

...
#ifndef _SeedFilling1_Core_HH_
#define _SeedFilling1_Core_HH_
...
#include "SeedFilling1_CoreeOg.h"
#include "fifo_w32_d2_A.h"
#include "fifo_w8_d2_A.h"
#include "start_for_Mat2Arrg8j.h"
#include "start_for_Mat2AXIhbi.h"
#include "SeedFilling1_Core_ctrl_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_CTRL_ADDR_WIDTH = 6,
         unsigned int C_S_AXI_CTRL_DATA_WIDTH = 32>
struct SeedFilling1_Core : public sc_module {
    ...
    // Module declarations
    SeedFilling1_Core(sc_module_name name);
    SC_HAS_PROCESS(SeedFilling1_Core);
    ...
    SeedFilling1_Core_ctrl_s_axi<C_S_AXI_CTRL_ADDR_WIDTH,C_S_AXI_CTRL_DATA_WIDTH>* SeedFilling1_Core_ctrl_s_axi_U;
    SeedFilling1_CoreeOg* src_val_U;
    SeedFilling1_CoreeOg* label_val_U;
    ...
    sc_signal< sc_lv<8> > label_val_i_q0;
    sc_signal< sc_lv<8> > label_val_t_q0;
    ...
    sc_signal< sc_lv<18> > SeedFilling_U0_label_val_address0;
    sc_signal< sc_logic > SeedFilling_U0_label_val_ce0;
    sc_signal< sc_logic > SeedFilling_U0_label_val_we0;
    sc_signal< sc_lv<8> > SeedFilling_U0_label_val_d0;
    sc_signal< sc_lv<32> > SeedFilling_U0_num;
    sc_signal< sc_logic > SeedFilling_U0_num_ap_vld;
    sc_signal< sc_lv<32> > SeedFilling_U0_label_rows_din;
    sc_signal< sc_logic > SeedFilling_U0_label_rows_write;
    sc_signal< sc_lv<32> > SeedFilling_U0_label_cols_din;
    sc_signal< sc_logic > SeedFilling_U0_label_cols_write;
    sc_signal< sc_logic > ap_channel_done_label_val;
    sc_signal< sc_logic > SeedFilling_U0_label_val_full_n;
    sc_signal< sc_logic > ap_sync_reg_channel_write_label_val;
    sc_signal< sc_logic > ap_sync_channel_write_label_val;
    ...
    sc_signal< sc_lv<18> > Array2D2Mat_U0_arr_val_address0;
    ...
    sc_signal< sc_logic > label_val_i_full_n;
    sc_signal< sc_logic > label_val_t_empty_n;
    ...
    sc_signal< sc_logic > label_rows_c_full_n;
    sc_signal< sc_lv<32> > label_rows_c_dout;
    sc_signal< sc_logic > label_rows_c_empty_n;
    sc_signal< sc_logic > label_cols_c_full_n;
    sc_signal< sc_lv<32> > label_cols_c_dout;
    sc_signal< sc_logic > label_cols_c_empty_n;
    sc_signal< sc_logic > p_label_data_stream_0_full_n;
    sc_signal< sc_lv<8> > p_label_data_stream_0_dout;
    sc_signal< sc_logic > p_label_data_stream_0_empty_n;
    sc_signal< sc_logic > p_label_rows_V_c_full_n;
    sc_signal< sc_lv<32> > p_label_rows_V_c_dout;
    sc_signal< sc_logic > p_label_rows_V_c_empty_n;
    sc_signal< sc_logic > p_label_cols_V_c_full_n;
    sc_signal< sc_lv<32> > p_label_cols_V_c_dout;
    sc_signal< sc_logic > p_label_cols_V_c_empty_n;
    ...
    void thread_SeedFilling_U0_label_val_full_n();
    void thread_SeedFilling_U0_start_full_n();
    void thread_SeedFilling_U0_start_write();
    void thread_ap_channel_done_label_val();
    ...
    void thread_ap_sync_channel_write_label_val();

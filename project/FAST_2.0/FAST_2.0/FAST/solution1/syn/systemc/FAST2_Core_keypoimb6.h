...
#ifndef _FAST2_Core_keypoimb6_H_
#define _FAST2_Core_keypoimb6_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "FAST2_Core_keypoimb6_memcore.h"

SC_MODULE(FAST2_Core_keypoimb6) {
...
protected:
    ...
    // buffer instances
    FAST2_Core_keypoimb6_memcore* buffer[BufferCount];
...
public:
    ...
    SC_CTOR(FAST2_Core_keypoimb6) : m_trace_file(0) {
        for (unsigned i = 0; i < BufferCount; i++) {
            char szTmp[128];
            sprintf(szTmp, "%d", i);
            std::string name = "FAST2_Core_keypoimb6_memcore_U_";
            name += szTmp;

            buffer[i] = new FAST2_Core_keypoimb6_memcore(name.c_str());
            buffer[i]->clk      ( clk );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "FAST2_Core_keypoimb6.trace");
            // ports

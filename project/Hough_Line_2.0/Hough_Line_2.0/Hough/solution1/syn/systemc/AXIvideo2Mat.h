...
struct AXIvideo2Mat : public sc_module {
    ...
    sc_signal< sc_lv<1> > exitcond_i_reg_372;
    sc_signal< sc_lv<1> > brmerge_i_reg_381;
    ...
    sc_signal< sc_lv<32> > t_V_20_reg_172;
    sc_signal< sc_lv<1> > eol_i_reg_183;
    sc_signal< sc_lv<1> > eol_reg_195;
    sc_signal< sc_lv<8> > axi_data_V_1_i_reg_206;
    sc_signal< sc_lv<1> > axi_last_V_3_i_reg_254;
    sc_signal< sc_lv<8> > axi_data_V_3_i_reg_266;
    sc_signal< sc_lv<32> > rows_V_reg_333;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<32> > cols_V_reg_338;
    sc_signal< sc_lv<8> > tmp_data_V_reg_343;
    sc_signal< sc_lv<1> > tmp_last_V_reg_351;
    sc_signal< sc_lv<1> > exitcond9_i_fu_297_p2;
    sc_signal< sc_logic > ap_CS_fsm_state4;
    sc_signal< sc_lv<32> > i_V_fu_302_p2;
    sc_signal< sc_lv<32> > i_V_reg_367;
    ...
    sc_signal< sc_lv<32> > j_V_fu_313_p2;
    sc_signal< sc_logic > ap_enable_reg_pp1_iter0;
    sc_signal< sc_lv<1> > brmerge_i_fu_322_p2;
    ...
    sc_signal< sc_lv<1> > ap_phi_mux_eol_2_i_phi_fu_246_p4;
    sc_signal< sc_lv<1> > axi_last_V1_i_reg_141;
    sc_signal< sc_logic > ap_CS_fsm_state10;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<8> > axi_data_V1_i_reg_151;
    sc_signal< sc_lv<32> > t_V_reg_161;
    sc_signal< sc_lv<1> > ap_phi_mux_eol_i_phi_fu_187_p4;
    sc_signal< sc_lv<1> > ap_phi_mux_axi_last_V_2_i_phi_fu_222_p4;
    sc_signal< sc_lv<8> > ap_phi_mux_p_Val2_s_phi_fu_234_p4;
    sc_signal< sc_lv<1> > ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_217;
    sc_signal< sc_lv<8> > ap_phi_reg_pp1_iter1_p_Val2_s_reg_230;
    sc_signal< bool > ap_block_pp1_stage0_01001;
    sc_signal< sc_lv<1> > sof_1_i_fu_84;
    sc_signal< sc_lv<1> > tmp_user_V_fu_288_p1;
    ...
    void thread_ap_phi_mux_axi_last_V_2_i_phi_fu_222_p4();
    void thread_ap_phi_mux_eol_2_i_phi_fu_246_p4();
    void thread_ap_phi_mux_eol_i_phi_fu_187_p4();
    void thread_ap_phi_mux_p_Val2_s_phi_fu_234_p4();
    void thread_ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_217();
    void thread_ap_phi_reg_pp1_iter1_p_Val2_s_reg_230();
    void thread_ap_predicate_op69_read_state6();
    void thread_ap_ready();
    void thread_brmerge_i_fu_322_p2();
    void thread_exitcond9_i_fu_297_p2();
    void thread_exitcond_i_fu_308_p2();
    void thread_i_V_fu_302_p2();

...
set C_modelArgList {
	{ arr_val int 8 regular {array 250000 { 1 3 } 1 1 }  }
	{ arr_rows int 32 regular {fifo 0}  }
	{ arr_cols int 32 regular {fifo 0}  }
	{ mat_data_stream_V int 8 regular {fifo 1 volatile }  }
	{ mat_rows_V int 32 regular {fifo 1}  }
	{ mat_cols_V int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "arr_val", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "arr_rows", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "arr_cols", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "mat_data_stream_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "mat_rows_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "mat_cols_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "arr_val_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "arr_val", "role": "address0" }} , 
 	...
 	{ "name": "arr_rows_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "arr_rows", "role": "dout" }} , 
 	...
 	{ "name": "arr_cols_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "arr_cols", "role": "dout" }} , 
 	...
 	{ "name": "mat_rows_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mat_rows_V", "role": "din" }} , 
 	...
 	{ "name": "mat_cols_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mat_cols_V", "role": "din" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "251501"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "251501"}
]}
...
set Spec2ImplPortList { 
	arr_val { ap_memory {  { arr_val_address0 mem_address 1 18 }  { arr_val_ce0 mem_ce 1 1 }  { arr_val_q0 mem_dout 0 8 } } }
	arr_rows { ap_fifo {  { arr_rows_dout fifo_data 0 32 }  { arr_rows_empty_n fifo_status 0 1 }  { arr_rows_read fifo_update 1 1 } } }
	arr_cols { ap_fifo {  { arr_cols_dout fifo_data 0 32 }  { arr_cols_empty_n fifo_status 0 1 }  { arr_cols_read fifo_update 1 1 } } }
	...
	mat_rows_V { ap_fifo {  { mat_rows_V_din fifo_data 1 32 }  { mat_rows_V_full_n fifo_status 0 1 }  { mat_rows_V_write fifo_update 1 1 } } }
	mat_cols_V { ap_fifo {  { mat_cols_V_din fifo_data 1 32 }  { mat_cols_V_full_n fifo_status 0 1 }  { mat_cols_V_write fifo_update 1 1 } } }
}

...
#ifndef __Haaris_Core_mac_mkbM__HH__
#define __Haaris_Core_mac_mkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mkbM) {
    ...
    SC_CTOR(Haaris_Core_mac_mkbM):  simcore_mac_2_U ("simcore_mac_2_U") {

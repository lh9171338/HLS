...
#ifndef __sin_or_cos_float_fYi_H__
#define __sin_or_cos_float_fYi_H__
...
struct sin_or_cos_float_fYi_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sin_or_cos_float_fYi_ram) {
...
SC_MODULE(sin_or_cos_float_fYi) {
...
sin_or_cos_float_fYi_ram* meminst;


SC_CTOR(sin_or_cos_float_fYi) {
meminst = new sin_or_cos_float_fYi_ram("sin_or_cos_float_fYi_ram");

...
void Mat2AXIvideo::thread_axi_last_V_fu_207_p2() {
    axi_last_V_fu_207_p2 = (!tmp_4_cast_i_fu_203_p1.read().is_01() || !r_V_reg_238.read().is_01())? sc_lv<1>(): sc_lv<1>(tmp_4_cast_i_fu_203_p1.read() == r_V_reg_238.read());
}

void Mat2AXIvideo::thread_cols_V_fu_162_p1() {
    cols_V_fu_162_p1 = esl_sext<32,11>(img_cols_V_dout.read());
}
...
void Mat2AXIvideo::thread_tmp_4_cast_i_fu_203_p1() {
    tmp_4_cast_i_fu_203_p1 = esl_zext<33,32>(t_V_1_reg_147.read());
}

...
#ifndef __Haaris_Core_mac_mpcA__HH__
#define __Haaris_Core_mac_mpcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mpcA) {
    ...
    SC_CTOR(Haaris_Core_mac_mpcA):  simcore_mac_7_U ("simcore_mac_7_U") {

set moduleName Result2Array2D_511_s
...
set C_modelName {Result2Array2D<511>}
...
set C_modelArgList {
	...
	{ matches_val_idx0 int 16 regular {array 511 { 1 3 } 1 1 }  }
	{ matches_val_idx1 int 16 regular {array 511 { 1 3 } 1 1 }  }
	{ matches_length int 32 regular {fifo 0}  }
	{ dst_val int 8 regular {array 4096 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "keypoints_val_pt_x", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "matches_val_idx0", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "matches_val_idx1", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "matches_length", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ matches_val_idx0_address0 sc_out sc_lv 9 signal 3 } 
	{ matches_val_idx0_ce0 sc_out sc_logic 1 signal 3 } 
	{ matches_val_idx0_q0 sc_in sc_lv 16 signal 3 } 
	{ matches_val_idx1_address0 sc_out sc_lv 9 signal 4 } 
	{ matches_val_idx1_ce0 sc_out sc_logic 1 signal 4 } 
	{ matches_val_idx1_q0 sc_in sc_lv 16 signal 4 } 
	{ matches_length_dout sc_in sc_lv 32 signal 5 } 
	{ matches_length_empty_n sc_in sc_logic 1 signal 5 } 
	{ matches_length_read sc_out sc_logic 1 signal 5 } 
	{ dst_val_address0 sc_out sc_lv 12 signal 6 } 
	{ dst_val_ce0 sc_out sc_logic 1 signal 6 } 
	{ dst_val_we0 sc_out sc_logic 1 signal 6 } 
	{ dst_val_d0 sc_out sc_lv 8 signal 6 } 
	{ dst_val_address1 sc_out sc_lv 12 signal 6 } 
	{ dst_val_ce1 sc_out sc_logic 1 signal 6 } 
	{ dst_val_we1 sc_out sc_logic 1 signal 6 } 
	{ dst_val_d1 sc_out sc_lv 8 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "matches_val_idx0_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "matches_val_idx0", "role": "q0" }} , 
 	...
 	{ "name": "matches_val_idx1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "matches_val_idx1", "role": "q0" }} , 
 	{ "name": "matches_length_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "matches_length", "role": "dout" }} , 
 	...
 	{ "name": "dst_val_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "dst_val", "role": "address0" }} , 
 	...
 	{ "name": "dst_val_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "dst_val", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "matches_val_idx0", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "matches_val_idx1", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4193", "Max" : "4193"}
	, {"Name" : "Interval", "Min" : "4193", "Max" : "4193"}
]}
...
set Spec2ImplPortList { 
	...
	matches_val_idx0 { ap_memory {  { matches_val_idx0_address0 mem_address 1 9 }  { matches_val_idx0_ce0 mem_ce 1 1 }  { matches_val_idx0_q0 mem_dout 0 16 } } }
	matches_val_idx1 { ap_memory {  { matches_val_idx1_address0 mem_address 1 9 }  { matches_val_idx1_ce0 mem_ce 1 1 }  { matches_val_idx1_q0 mem_dout 0 16 } } }
	matches_length { ap_fifo {  { matches_length_dout fifo_data 0 32 }  { matches_length_empty_n fifo_status 0 1 }  { matches_length_read fifo_update 1 1 } } }
	dst_val { ap_memory {  { dst_val_address0 mem_address 1 12 }  { dst_val_ce0 mem_ce 1 1 }  { dst_val_we0 mem_we 1 1 }  { dst_val_d0 mem_din 1 8 }  { dst_val_address1 mem_address 1 12 }  { dst_val_ce1 mem_ce 1 1 }  { dst_val_we1 mem_we 1 1 }  { dst_val_d1 mem_din 1 8 } } }
}

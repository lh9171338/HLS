...
wire   [7:0] src_val_i_q1;
wire   [7:0] src_val_t_q0;
wire   [7:0] src_val_t_q1;
...
wire   [31:0] Block_Mat_exit11_pro_U0_p_src_rows_V_out_din;
wire    Block_Mat_exit11_pro_U0_p_src_rows_V_out_write;
wire   [31:0] Block_Mat_exit11_pro_U0_p_src_cols_V_out_din;
wire    Block_Mat_exit11_pro_U0_p_src_cols_V_out_write;
wire   [31:0] Block_Mat_exit11_pro_U0_param_out_din;
wire    Block_Mat_exit11_pro_U0_param_out_write;
...
wire    Rotate_U0_ap_start;
wire    Rotate_U0_start_full_n;
wire    Rotate_U0_ap_done;
wire    Rotate_U0_ap_continue;
wire    Rotate_U0_ap_idle;
wire    Rotate_U0_ap_ready;
wire    Rotate_U0_start_out;
wire    Rotate_U0_start_write;
wire   [15:0] Rotate_U0_src_val_address0;
wire    Rotate_U0_src_val_ce0;
wire   [15:0] Rotate_U0_src_val_address1;
wire    Rotate_U0_src_val_ce1;
wire    Rotate_U0_src_rows_read;
wire    Rotate_U0_src_cols_read;
wire   [15:0] Rotate_U0_dst_val_address0;
wire    Rotate_U0_dst_val_ce0;
wire    Rotate_U0_dst_val_we0;
wire   [7:0] Rotate_U0_dst_val_d0;
wire    Rotate_U0_theta_read;
wire   [16:0] Rotate_U0_dst_rows_out_din;
wire    Rotate_U0_dst_rows_out_write;
wire   [16:0] Rotate_U0_dst_rows_out1_din;
wire    Rotate_U0_dst_rows_out1_write;
wire   [16:0] Rotate_U0_dst_cols_out_din;
wire    Rotate_U0_dst_cols_out_write;
wire   [16:0] Rotate_U0_dst_cols_out2_din;
wire    Rotate_U0_dst_cols_out2_write;
wire    ap_channel_done_dst_val;
wire    Rotate_U0_dst_val_full_n;
wire    Block_Mat_exit1117_p_U0_ap_start;
wire    Block_Mat_exit1117_p_U0_ap_done;
wire    Block_Mat_exit1117_p_U0_ap_continue;
wire    Block_Mat_exit1117_p_U0_ap_idle;
wire    Block_Mat_exit1117_p_U0_ap_ready;
wire    Block_Mat_exit1117_p_U0_dst_rows_read;
wire   [31:0] Block_Mat_exit1117_p_U0_rows1;
wire    Block_Mat_exit1117_p_U0_rows1_ap_vld;
wire    ap_sync_continue;
wire    Block_Mat_exit1120_p_U0_ap_start;
wire    Block_Mat_exit1120_p_U0_ap_done;
wire    Block_Mat_exit1120_p_U0_ap_continue;
wire    Block_Mat_exit1120_p_U0_ap_idle;
wire    Block_Mat_exit1120_p_U0_ap_ready;
wire    Block_Mat_exit1120_p_U0_dst_cols_read;
wire   [31:0] Block_Mat_exit1120_p_U0_cols1;
wire    Block_Mat_exit1120_p_U0_cols1_ap_vld;
...
wire   [16:0] Array2D2Mat_U0_mat_rows_V_din;
wire    Array2D2Mat_U0_mat_rows_V_write;
wire   [16:0] Array2D2Mat_U0_mat_cols_V_din;
...
wire    p_src_rows_V_c31_full_n;
wire   [31:0] p_src_rows_V_c31_dout;
wire    p_src_rows_V_c31_empty_n;
wire    p_src_cols_V_c32_full_n;
wire   [31:0] p_src_cols_V_c32_dout;
wire    p_src_cols_V_c32_empty_n;
...
wire   [16:0] dst_rows_c_dout;
wire    dst_rows_c_empty_n;
wire    dst_rows_c33_full_n;
wire   [16:0] dst_rows_c33_dout;
wire    dst_rows_c33_empty_n;
wire    dst_cols_c_full_n;
wire   [16:0] dst_cols_c_dout;
wire    dst_cols_c_empty_n;
wire    dst_cols_c34_full_n;
wire   [16:0] dst_cols_c34_dout;
wire    dst_cols_c34_empty_n;
...
wire   [16:0] p_dst_rows_V_c_dout;
wire    p_dst_rows_V_c_empty_n;
wire    p_dst_cols_V_c_full_n;
wire   [16:0] p_dst_cols_V_c_dout;
...
wire   [0:0] start_for_Block_Mat_exit1117_p_U0_din;
wire    start_for_Block_Mat_exit1117_p_U0_full_n;
wire   [0:0] start_for_Block_Mat_exit1117_p_U0_dout;
wire    start_for_Block_Mat_exit1117_p_U0_empty_n;
wire   [0:0] start_for_Block_Mat_exit1120_p_U0_din;
wire    start_for_Block_Mat_exit1120_p_U0_full_n;
wire   [0:0] start_for_Block_Mat_exit1120_p_U0_dout;
wire    start_for_Block_Mat_exit1120_p_U0_empty_n;
wire    Block_Mat_exit1117_p_U0_start_full_n;
wire    Block_Mat_exit1117_p_U0_start_write;
wire    Block_Mat_exit1120_p_U0_start_full_n;
wire    Block_Mat_exit1120_p_U0_start_write;
...
Rotate_Core_ctrl_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_CTRL_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_CTRL_DATA_WIDTH ))
Rotate_Core_ctrl_s_axi_U(
...
Block_Mat_exit1117_p Block_Mat_exit1117_p_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
Block_Mat_exit1120_p Block_Mat_exit1120_p_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
fifo_w32_d2_A p_src_rows_V_c31_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A p_src_cols_V_c32_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w17_d2_A p_dst_rows_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w17_d2_A p_dst_cols_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_Mat2Arrncg start_for_Mat2Arrncg_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_Block_Mocq start_for_Block_Mocq_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_Block_MpcA start_for_Block_MpcA_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (((ap_sync_ready == 1'b1) & (1'b0 == Block_Mat_exit11_pro_U0_ap_ready))) begin
        Block_Mat_exit11_pro_U0_ap_ready_count <= (Block_Mat_exit11_pro_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == Block_Mat_exit11_pro_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        Block_Mat_exit11_pro_U0_ap_ready_count <= (Block_Mat_exit11_pro_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_Mat_exit1117_p_U0_ap_continue = ap_sync_done;

assign Block_Mat_exit1117_p_U0_ap_start = start_for_Block_Mat_exit1117_p_U0_empty_n;

assign Block_Mat_exit1117_p_U0_start_full_n = 1'b1;

assign Block_Mat_exit1117_p_U0_start_write = 1'b0;

assign Block_Mat_exit1120_p_U0_ap_continue = ap_sync_done;

assign Block_Mat_exit1120_p_U0_ap_start = start_for_Block_Mat_exit1120_p_U0_empty_n;

assign Block_Mat_exit1120_p_U0_start_full_n = 1'b1;

assign Block_Mat_exit1120_p_U0_start_write = 1'b0;
...
assign Block_Mat_exit11_pro_U0_start_full_n = 1'b1;

assign Block_Mat_exit11_pro_U0_start_write = 1'b0;
...
assign Rotate_U0_ap_continue = dst_val_i_full_n;

assign Rotate_U0_ap_start = src_val_t_empty_n;

assign Rotate_U0_dst_val_full_n = dst_val_i_full_n;

assign Rotate_U0_start_full_n = (start_for_Block_Mat_exit1120_p_U0_full_n & start_for_Block_Mat_exit1117_p_U0_full_n);

assign ap_channel_done_dst_val = Rotate_U0_ap_done;

assign ap_channel_done_src_val = Mat2Array2D_U0_ap_done;

assign ap_done = ap_sync_done;

assign ap_idle = ((dst_val_t_empty_n ^ 1'b1) & (src_val_t_empty_n ^ 1'b1) & Rotate_U0_ap_idle & Mat2Array2D_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & Block_Mat_exit11_pro_U0_ap_idle & Block_Mat_exit1120_p_U0_ap_idle & Block_Mat_exit1117_p_U0_ap_idle & Array2D2Mat_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign ap_sync_done = (Mat2AXIvideo_U0_ap_done & Block_Mat_exit1120_p_U0_ap_done & Block_Mat_exit1117_p_U0_ap_done);

assign ap_sync_ready = (ap_sync_Block_Mat_exit11_pro_U0_ap_ready & ap_sync_AXIvideo2Mat_U0_ap_ready);
...
assign src_val_t_d1 = 8'd0;

assign src_val_t_we1 = 1'b0;

assign start_for_Block_Mat_exit1117_p_U0_din = 1'b1;

assign start_for_Block_Mat_exit1120_p_U0_din = 1'b1;

assign start_for_Mat2AXIvideo_U0_din = 1'b1;

assign start_for_Mat2Array2D_U0_din = 1'b1;

endmodule //Rotate_Core

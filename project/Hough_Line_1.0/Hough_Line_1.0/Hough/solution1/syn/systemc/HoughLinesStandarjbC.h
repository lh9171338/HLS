...
#ifndef __HoughLinesStandarjbC_H__
#define __HoughLinesStandarjbC_H__
...
struct HoughLinesStandarjbC_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(HoughLinesStandarjbC_ram) {
...
SC_MODULE(HoughLinesStandarjbC) {
...
HoughLinesStandarjbC_ram* meminst;


SC_CTOR(HoughLinesStandarjbC) {
meminst = new HoughLinesStandarjbC_ram("HoughLinesStandarjbC_ram");

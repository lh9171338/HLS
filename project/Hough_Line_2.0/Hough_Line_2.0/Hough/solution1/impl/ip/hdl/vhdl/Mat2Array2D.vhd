...
architecture behav of Mat2Array2D is 
    ...
    signal tmp_88_i_reg_231 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_16_fu_173_p2 : STD_LOGIC_VECTOR (17 downto 0);
    signal tmp_16_reg_226 : STD_LOGIC_VECTOR (17 downto 0);
    signal tmp_88_i_fu_183_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state3_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state4_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal j_fu_188_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal tmp_17_fu_198_p2 : STD_LOGIC_VECTOR (17 downto 0);
    signal tmp_17_reg_240 : STD_LOGIC_VECTOR (17 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state3 : STD_LOGIC;
    signal i_i_reg_112 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal tmp_17_cast_fu_203_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_cast_i_fu_134_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_fu_149_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_118_fu_161_p1 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_120_fu_194_p1 : STD_LOGIC_VECTOR (17 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((tmp_88_i_fu_183_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_i_fu_138_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    tmp_16_reg_226(17 downto 6) <= tmp_16_fu_173_p2(17 downto 6);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_88_i_fu_183_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_17_reg_240 <= tmp_17_fu_198_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_88_i_reg_231 <= tmp_88_i_fu_183_p2;
            end if;
        end if;
    end process;
    tmp_16_reg_226(5 downto 0) <= "000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, mat_rows_V_empty_n, mat_cols_V_empty_n, arr_rows_full_n, arr_cols_full_n, tmp_i_fu_138_p2, ap_CS_fsm_state2, tmp_88_i_fu_183_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (tmp_88_i_fu_183_p2 = ap_const_lv1_0)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (tmp_88_i_fu_183_p2 = ap_const_lv1_0))) then
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(mat_data_stream_V_empty_n, ap_enable_reg_pp0_iter1, tmp_88_i_reg_231)
    begin
                ap_block_pp0_stage0_11001 <= ((tmp_88_i_reg_231 = ap_const_lv1_1) and (mat_data_stream_V_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(mat_data_stream_V_empty_n, ap_enable_reg_pp0_iter1, tmp_88_i_reg_231)
    begin
                ap_block_pp0_stage0_subdone <= ((tmp_88_i_reg_231 = ap_const_lv1_1) and (mat_data_stream_V_empty_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    ap_block_state4_pp0_stage0_iter1_assign_proc : process(mat_data_stream_V_empty_n, tmp_88_i_reg_231)
    begin
                ap_block_state4_pp0_stage0_iter1 <= ((tmp_88_i_reg_231 = ap_const_lv1_1) and (mat_data_stream_V_empty_n = ap_const_logic_0));
    end process;


    ap_condition_pp0_exit_iter0_state3_assign_proc : process(tmp_88_i_fu_183_p2)
    begin
        if ((tmp_88_i_fu_183_p2 = ap_const_lv1_0)) then 
    ...
    arr_val_address0 <= tmp_17_cast_fu_203_p1(17 - 1 downto 0);
    ...
    arr_val_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_88_i_reg_231, ap_block_pp0_stage0_11001)
    begin
        if (((tmp_88_i_reg_231 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    mat_data_stream_V_blk_n_assign_proc : process(mat_data_stream_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_88_i_reg_231)
    begin
        if (((tmp_88_i_reg_231 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    mat_data_stream_V_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_88_i_reg_231, ap_block_pp0_stage0_11001)
    begin
        if (((tmp_88_i_reg_231 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    p_shl1_cast_fu_165_p3 <= (tmp_118_fu_161_p1 & ap_const_lv6_0);
    p_shl_cast_fu_153_p3 <= (tmp_fu_149_p1 & ap_const_lv8_0);
    tmp_118_fu_161_p1 <= i_i_reg_112(12 - 1 downto 0);
    tmp_120_fu_194_p1 <= j_i_reg_123(18 - 1 downto 0);
    tmp_16_fu_173_p2 <= std_logic_vector(unsigned(p_shl_cast_fu_153_p3) + unsigned(p_shl1_cast_fu_165_p3));
    tmp_17_cast_fu_203_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_17_reg_240),64));
    tmp_17_fu_198_p2 <= std_logic_vector(unsigned(tmp_16_reg_226) + unsigned(tmp_120_fu_194_p1));
    tmp_88_i_fu_183_p2 <= "1" when (signed(j_cast_i_fu_179_p1) < signed(cols_reg_212)) else "0";

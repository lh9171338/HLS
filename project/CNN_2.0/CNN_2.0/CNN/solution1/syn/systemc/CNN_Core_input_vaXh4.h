...
#ifndef _CNN_Core_input_vaXh4_H_
#define _CNN_Core_input_vaXh4_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "CNN_Core_input_vaXh4_memcore.h"

SC_MODULE(CNN_Core_input_vaXh4) {
    static const unsigned int DataWidth    = 24;
...
protected:
    ...
    CNN_Core_input_vaXh4_memcore* CNN_Core_input_vaXh4_memcore_U;
...
public:
    ...
    SC_CTOR(CNN_Core_input_vaXh4) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        CNN_Core_input_vaXh4_memcore_U = new CNN_Core_input_vaXh4_memcore("CNN_Core_input_vaXh4_memcore_U");
        CNN_Core_input_vaXh4_memcore_U->clk      ( clk );
        CNN_Core_input_vaXh4_memcore_U->reset    ( reset );
        CNN_Core_input_vaXh4_memcore_U->ce0      ( i_ce0 );
        CNN_Core_input_vaXh4_memcore_U->we0      ( i_we0 );
        CNN_Core_input_vaXh4_memcore_U->address0 ( memcore_iaddr );
        CNN_Core_input_vaXh4_memcore_U->d0       ( i_d0 );
        CNN_Core_input_vaXh4_memcore_U->q0       ( i_q0 );

        CNN_Core_input_vaXh4_memcore_U->ce1      ( t_ce0 );
        CNN_Core_input_vaXh4_memcore_U->we1      ( t_we0 );
        CNN_Core_input_vaXh4_memcore_U->address1 ( memcore_taddr );
        CNN_Core_input_vaXh4_memcore_U->d1       ( t_d0 );
        CNN_Core_input_vaXh4_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "CNN_Core_input_vaXh4.trace");
            // ports

...
set C_modelArgList {
	...
	{ array_val int 8 regular {array 76800 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mat_rows_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "array_val", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ array_val_address0 sc_out sc_lv 17 signal 3 } 
	{ array_val_ce0 sc_out sc_logic 1 signal 3 } 
	{ array_val_we0 sc_out sc_logic 1 signal 3 } 
	{ array_val_d0 sc_out sc_lv 8 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "array_val_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "array_val", "role": "address0" }} , 
 	{ "name": "array_val_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "array_val", "role": "ce0" }} , 
 	{ "name": "array_val_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "array_val", "role": "we0" }} , 
 	{ "name": "array_val_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "array_val", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "array_val", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"}]}]}
...
set Spec2ImplPortList { 
	...
	array_val { ap_memory {  { array_val_address0 mem_address 1 17 }  { array_val_ce0 mem_ce 1 1 }  { array_val_we0 mem_we 1 1 }  { array_val_d0 mem_din 1 8 } } }
}

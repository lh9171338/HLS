...
#ifndef __Haaris_Core_mac_mdEe__HH__
#define __Haaris_Core_mac_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haaris_Core_mac_mdEe) {
    ...
    SC_CTOR(Haaris_Core_mac_mdEe):  simcore_mac_1_U ("simcore_mac_1_U") {

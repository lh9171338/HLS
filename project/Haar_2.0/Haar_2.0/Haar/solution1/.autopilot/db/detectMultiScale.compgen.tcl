...
set ID 573
set hasByteEnable 0
set MemName detectMultiScale_bil
...
set ID 574
set hasByteEnable 0
set MemName detectMultiScale_bjl
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 16
set AddrRange 1000
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_locations_rows \
    op interface \
    ports { locations_rows_dout { I 4 vector } locations_rows_empty_n { I 1 bit } locations_rows_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_locations_cols \
    op interface \
    ports { locations_cols_dout { I 8 vector } locations_cols_empty_n { I 1 bit } locations_cols_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_scale0 \
    op interface \
    ports { p_scale0_dout { I 32 vector } p_scale0_empty_n { I 1 bit } p_scale0_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { neighbors_dout { I 32 vector } neighbors_empty_n { I 1 bit } neighbors_read { O 1 bit } } \
} "
}

...
#ifndef __Haar_Core_mul_mulvdy__HH__
#define __Haar_Core_mul_mulvdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haar_Core_mul_mulvdy) {
    ...
    SC_CTOR(Haar_Core_mul_mulvdy):  ACMP_smul_su_U ("ACMP_smul_su_U") {

...
#ifndef __HoughLinesStandarkbM_H__
#define __HoughLinesStandarkbM_H__
...
struct HoughLinesStandarkbM_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(HoughLinesStandarkbM_ram) {
...
SC_MODULE(HoughLinesStandarkbM) {
...
HoughLinesStandarkbM_ram* meminst;


SC_CTOR(HoughLinesStandarkbM) {
meminst = new HoughLinesStandarkbM_ram("HoughLinesStandarkbM_ram");

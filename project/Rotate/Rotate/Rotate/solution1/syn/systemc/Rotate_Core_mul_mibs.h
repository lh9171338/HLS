...
#ifndef __Rotate_Core_mul_mibs__HH__
#define __Rotate_Core_mul_mibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Rotate_Core_mul_mibs) {
    ...
    SC_CTOR(Rotate_Core_mul_mibs):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

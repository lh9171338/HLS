...
#ifndef __CNN_Core_sdiv_48ndEe__HH__
#define __CNN_Core_sdiv_48ndEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(CNN_Core_sdiv_48ndEe) {
    ...
    SC_CTOR(CNN_Core_sdiv_48ndEe):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {

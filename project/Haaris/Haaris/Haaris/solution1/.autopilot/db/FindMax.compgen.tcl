...
set ID 287
set hasByteEnable 0
set MemName FindMax_k_buf_val_0
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_src_data_stream_V_dout { I 32 vector } p_src_data_stream_V_empty_n { I 1 bit } p_src_data_stream_V_read { O 1 bit } } \
} "
}

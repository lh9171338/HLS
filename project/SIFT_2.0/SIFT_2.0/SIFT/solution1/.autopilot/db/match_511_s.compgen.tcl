...
set out_width 24
set exp i0*i1+i2
set arg_lists {i0 {9 1 +} i1 {9 1 +} m {18 1 +} i2 {24 1 +} p {24 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { descriptors0_val_val_address0 { O 16 vector } descriptors0_val_val_ce0 { O 1 bit } descriptors0_val_val_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { descriptors1_val_val_address0 { O 16 vector } descriptors1_val_val_ce0 { O 1 bit } descriptors1_val_val_q0 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 1088 \
    name descriptors0_length_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_descriptors0_length_read \
    op interface \
    ports { descriptors0_length_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 1090 \
    name descriptors1_length_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_descriptors1_length_read \
    op interface \
    ports { descriptors1_length_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 1094 \
    name matches_length_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_matches_length_read \
    op interface \
    ports { matches_length_read { I 1 vector } } \
} "
}

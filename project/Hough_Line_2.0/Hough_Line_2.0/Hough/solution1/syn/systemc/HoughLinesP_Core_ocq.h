...
#ifndef __HoughLinesP_Core_ocq__HH__
#define __HoughLinesP_Core_ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughLinesP_Core_ocq) {
    ...
    SC_CTOR(HoughLinesP_Core_ocq):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

...
wire   [63:0] tmp_10_cast_fu_189_p1;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] i_cast_i_fu_150_p1;
wire   [31:0] j_cast_i_fu_165_p1;
wire   [18:0] tmp_18_fu_180_p1;
wire   [18:0] tmp_s_fu_184_p2;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (((tmp_i_fu_154_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        j_i_reg_129 <= 31'd0;
    end else if (((tmp_35_i_fu_169_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((tmp_35_i_fu_169_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((tmp_35_i_reg_223 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((tmp_35_i_reg_223 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (tmp_35_i_fu_169_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (tmp_35_i_fu_169_p2 == 1'd0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((tmp_35_i_reg_223 == 1'd1) & (mat_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((tmp_35_i_reg_223 == 1'd1) & (mat_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((tmp_35_i_reg_223 == 1'd1) & (mat_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((tmp_35_i_reg_223 == 1'd1) & (mat_data_stream_V_full_n == 1'b0));
end
...
assign arr_val_address0 = tmp_10_cast_fu_189_p1;
...
assign tmp_10_cast_fu_189_p1 = tmp_s_fu_184_p2;

assign tmp_18_fu_180_p1 = j_i_reg_129[18:0];

assign tmp_35_i_fu_169_p2 = (($signed(j_cast_i_fu_165_p1) < $signed(cols_reg_199)) ? 1'b1 : 1'b0);

assign tmp_fu_140_p1 = phi_mul_reg_118[18:0];

assign tmp_i_fu_154_p2 = (($signed(i_cast_i_fu_150_p1) < $signed(rows_reg_194)) ? 1'b1 : 1'b0);

assign tmp_s_fu_184_p2 = (tmp_reg_204 + tmp_18_fu_180_p1);

...
void HoughLines_Core_etde::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void HoughLines_Core_etde::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void HoughLines_Core_etde::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void HoughLines_Core_etde::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {

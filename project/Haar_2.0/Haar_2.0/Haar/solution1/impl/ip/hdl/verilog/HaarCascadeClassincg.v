...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module HaarCascadeClassincg_rom (
...
initial begin
    $readmemh("./HaarCascadeClassincg_rom.dat", ram0);
    $readmemh("./HaarCascadeClassincg_rom.dat", ram1);
    $readmemh("./HaarCascadeClassincg_rom.dat", ram2);
end
...
HaarCascadeClassincg_rom HaarCascadeClassincg_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

...
#ifndef __SIFT2_Core_mul_mubjl__HH__
#define __SIFT2_Core_mul_mubjl__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(SIFT2_Core_mul_mubjl) {
    ...
    SC_CTOR(SIFT2_Core_mul_mubjl):  ACMP_smul_us_U ("ACMP_smul_us_U") {

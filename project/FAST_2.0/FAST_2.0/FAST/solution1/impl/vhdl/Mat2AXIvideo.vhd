...
architecture behav of Mat2AXIvideo is 
    ...
    signal tmp_4_cast_i_fu_203_p1 : STD_LOGIC_VECTOR (32 downto 0);
...
begin
    ...
    axi_last_V_fu_207_p2 <= "1" when (tmp_4_cast_i_fu_203_p1 = r_V_reg_238) else "0";
    ...
    tmp_4_cast_i_fu_203_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_V_1_reg_147),33));
end behav;

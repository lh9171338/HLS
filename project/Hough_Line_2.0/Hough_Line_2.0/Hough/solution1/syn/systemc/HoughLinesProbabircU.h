...
#ifndef __HoughLinesProbabircU_H__
#define __HoughLinesProbabircU_H__
...
struct HoughLinesProbabircU_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(HoughLinesProbabircU_ram) {
...
SC_MODULE(HoughLinesProbabircU) {
...
HoughLinesProbabircU_ram* meminst;


SC_CTOR(HoughLinesProbabircU) {
meminst = new HoughLinesProbabircU_ram("HoughLinesProbabircU_ram");

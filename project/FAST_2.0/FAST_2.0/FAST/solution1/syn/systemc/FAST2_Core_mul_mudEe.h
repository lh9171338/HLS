...
#ifndef __FAST2_Core_mul_mudEe__HH__
#define __FAST2_Core_mul_mudEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FAST2_Core_mul_mudEe) {
    ...
    SC_CTOR(FAST2_Core_mul_mudEe):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {

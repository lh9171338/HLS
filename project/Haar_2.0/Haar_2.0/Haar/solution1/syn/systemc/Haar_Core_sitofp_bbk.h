...
#ifndef __Haar_Core_sitofp_bbk__HH__
#define __Haar_Core_sitofp_bbk__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haar_Core_sitofp_bbk) {
    ...
    SC_CTOR(Haar_Core_sitofp_bbk):  ACMP_sitofp_U ("ACMP_sitofp_U") {

...
#ifndef __HaarCascadeClassimb6_H__
#define __HaarCascadeClassimb6_H__
...
struct HaarCascadeClassimb6_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(HaarCascadeClassimb6_ram) {
        ram[0] = "0b00010";
        ram[1] = "0b00010";
        ram[2] = "0b00000";
        ram[3] = "0b01000";
        ...
        ram[1695] = "0b01101";
        ram[1696] = "0b01101";
        for (unsigned i = 1697; i < 1704 ; i = i + 1) {
            ram[i] = "0b00000";
        }
        ram[1704] = "0b01010";
        ram[1705] = "0b01010";
        ...
        ram[2319] = "0b01001";
        ram[2320] = "0b01001";
        for (unsigned i = 2321; i < 2326 ; i = i + 1) {
            ram[i] = "0b00000";
        }
        ram[2326] = "0b00011";
        ram[2327] = "0b00000";
        ...
        ram[2925] = "0b10010";
        ram[2926] = "0b10010";
        for (unsigned i = 2927; i < 2934 ; i = i + 1) {
            ram[i] = "0b00000";
        }
        ram[2934] = "0b10001";
        ram[2935] = "0b10010";
        ...
        ram[3120] = "0b01111";
        ram[3121] = "0b01111";
        for (unsigned i = 3122; i < 3129 ; i = i + 1) {
            ram[i] = "0b00000";
        }
        ram[3129] = "0b00101";
        ram[3130] = "0b00101";
        ...
        ram[3208] = "0b10010";
        ram[3209] = "0b10000";
        for (unsigned i = 3210; i < 3215 ; i = i + 1) {
            ram[i] = "0b00000";
        }
        ram[3215] = "0b00010";
        ram[3216] = "0b01100";
...
SC_MODULE(HaarCascadeClassimb6) {
...
HaarCascadeClassimb6_ram* meminst;


SC_CTOR(HaarCascadeClassimb6) {
meminst = new HaarCascadeClassimb6_ram("HaarCascadeClassimb6_ram");

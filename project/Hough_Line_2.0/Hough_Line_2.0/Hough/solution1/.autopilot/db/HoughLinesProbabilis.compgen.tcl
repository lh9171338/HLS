...
set ID 71
set hasByteEnable 0
set MemName HoughLinesProbabipcA
...
set ID 72
set hasByteEnable 0
set MemName HoughLinesProbabircU
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 24
set AddrRange 32
...
set ID 73
set hasByteEnable 0
set MemName HoughLinesProbabisc4
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 32
set AddrRange 201780
set AddrWd 18
...
set ID 74
set hasByteEnable 0
set MemName HoughLinesProbabitde
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 1
set AddrRange 76800
...
set ID 75
set hasByteEnable 0
set MemName HoughLinesProbabiudo
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 16
set AddrRange 360
...
set ID 76
set hasByteEnable 0
set MemName HoughLinesProbabivdy
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 76800
...
set ID 77
set hasByteEnable 0
set MemName HoughLinesProbabixdS
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 2
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename lines_val \
    op interface \
    ports { lines_val_address0 { O 9 vector } lines_val_ce0 { O 1 bit } lines_val_we0 { O 1 bit } lines_val_d0 { O 16 vector } lines_val_address1 { O 9 vector } lines_val_ce1 { O 1 bit } lines_val_we1 { O 1 bit } lines_val_d1 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'lines_val'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_lines_rows \
    op interface \
    ports { lines_rows_dout { I 4 vector } lines_rows_empty_n { I 1 bit } lines_rows_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_lines_cols \
    op interface \
    ports { lines_cols_dout { I 8 vector } lines_cols_empty_n { I 1 bit } lines_cols_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_lineGap \
    op interface \
    ports { lineGap_dout { I 32 vector } lineGap_empty_n { I 1 bit } lineGap_read { O 1 bit } } \
} "
}

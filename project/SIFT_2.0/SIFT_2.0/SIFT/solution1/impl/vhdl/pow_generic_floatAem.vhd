...
entity pow_generic_floatAem_rom is 
    generic(
             DWIDTH     : integer := 52; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of pow_generic_floatAem_rom is 
...
entity pow_generic_floatAem is
    generic (
...
architecture arch of pow_generic_floatAem is
    component pow_generic_floatAem_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pow_generic_floatAem_rom_U :  component pow_generic_floatAem_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

...
#ifndef __Haar_Core_mac_mulibs__HH__
#define __Haar_Core_mac_mulibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Haar_Core_mac_mulibs) {
    ...
    SC_CTOR(Haar_Core_mac_mulibs):  simcore_mac_0_U ("simcore_mac_0_U") {

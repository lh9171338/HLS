...
Sobel_1::Sobel_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_Filter2D_fu_48 = new Filter2D("grp_Filter2D_fu_48");
    grp_Filter2D_fu_48->ap_clk(ap_clk);
    grp_Filter2D_fu_48->ap_rst(ap_rst);
    grp_Filter2D_fu_48->ap_start(grp_Filter2D_fu_48_ap_start);
    grp_Filter2D_fu_48->ap_done(grp_Filter2D_fu_48_ap_done);
    grp_Filter2D_fu_48->ap_idle(grp_Filter2D_fu_48_ap_idle);
    grp_Filter2D_fu_48->ap_ready(grp_Filter2D_fu_48_ap_ready);
    grp_Filter2D_fu_48->p_src_rows_V_read(p_src_rows_V_read_reg_72);
    grp_Filter2D_fu_48->p_src_cols_V_read(p_src_cols_V_read_reg_77);
    grp_Filter2D_fu_48->p_src_data_stream_V_dout(p_src_data_stream_V_dout);
    grp_Filter2D_fu_48->p_src_data_stream_V_empty_n(p_src_data_stream_V_empty_n);
    grp_Filter2D_fu_48->p_src_data_stream_V_read(grp_Filter2D_fu_48_p_src_data_stream_V_read);
    grp_Filter2D_fu_48->p_dst_data_stream_V_din(grp_Filter2D_fu_48_p_dst_data_stream_V_din);
    grp_Filter2D_fu_48->p_dst_data_stream_V_full_n(p_dst_data_stream_V_full_n);
    grp_Filter2D_fu_48->p_dst_data_stream_V_write(grp_Filter2D_fu_48_p_dst_data_stream_V_write);
    grp_Filter2D_fu_48->p_kernel_val_0_V_1_read(ap_var_for_const0);
    grp_Filter2D_fu_48->p_kernel_val_0_V_2_read(ap_var_for_const1);
    grp_Filter2D_fu_48->p_kernel_val_1_V_0_read(ap_var_for_const2);
    grp_Filter2D_fu_48->p_kernel_val_1_V_2_read(ap_var_for_const3);
    grp_Filter2D_fu_48->p_kernel_val_2_V_0_read(ap_var_for_const4);
    grp_Filter2D_fu_48->p_kernel_val_2_V_1_read(ap_var_for_const5);
    ...
    sensitive << ( ap_done_reg );
    sensitive << ( grp_Filter2D_fu_48_ap_done );
    ...
    SC_METHOD(thread_grp_Filter2D_fu_48_ap_start);
    sensitive << ( grp_Filter2D_fu_48_ap_start_reg );

    SC_METHOD(thread_p_dst_data_stream_V_din);
    sensitive << ( grp_Filter2D_fu_48_p_dst_data_stream_V_din );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_p_dst_data_stream_V_write);
    sensitive << ( grp_Filter2D_fu_48_p_dst_data_stream_V_write );
    sensitive << ( ap_CS_fsm_state2 );
    ...
    sensitive << ( grp_Filter2D_fu_48_p_src_data_stream_V_read );
    sensitive << ( ap_CS_fsm_state2 );
    ...
    ap_CS_fsm = "01";
    grp_Filter2D_fu_48_ap_start_reg = SC_LOGIC_0;
    ...
    sc_trace(mVcdFile, p_src_rows_V_read_reg_72, "p_src_rows_V_read_reg_72");
    sc_trace(mVcdFile, ap_block_state1, "ap_block_state1");
    sc_trace(mVcdFile, p_src_cols_V_read_reg_77, "p_src_cols_V_read_reg_77");
    sc_trace(mVcdFile, grp_Filter2D_fu_48_ap_start, "grp_Filter2D_fu_48_ap_start");
    sc_trace(mVcdFile, grp_Filter2D_fu_48_ap_done, "grp_Filter2D_fu_48_ap_done");
    sc_trace(mVcdFile, grp_Filter2D_fu_48_ap_idle, "grp_Filter2D_fu_48_ap_idle");
    sc_trace(mVcdFile, grp_Filter2D_fu_48_ap_ready, "grp_Filter2D_fu_48_ap_ready");
    sc_trace(mVcdFile, grp_Filter2D_fu_48_p_src_data_stream_V_read, "grp_Filter2D_fu_48_p_src_data_stream_V_read");
    sc_trace(mVcdFile, grp_Filter2D_fu_48_p_dst_data_stream_V_din, "grp_Filter2D_fu_48_p_dst_data_stream_V_din");
    sc_trace(mVcdFile, grp_Filter2D_fu_48_p_dst_data_stream_V_write, "grp_Filter2D_fu_48_p_dst_data_stream_V_write");
    sc_trace(mVcdFile, grp_Filter2D_fu_48_ap_start_reg, "grp_Filter2D_fu_48_ap_start_reg");
...
void Sobel_1::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
        } else if ((esl_seteq<1,1,1>(grp_Filter2D_fu_48_ap_done.read(), ap_const_logic_1) && 
                    esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
            ap_done_reg = ap_const_logic_1;
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
        grp_Filter2D_fu_48_ap_start_reg = ap_const_logic_0;
    } else {
        if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(p_src_cols_V_empty_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(p_src_rows_V_empty_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)) && 
            ...
            grp_Filter2D_fu_48_ap_start_reg = ap_const_logic_1;
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_Filter2D_fu_48_ap_ready.read())) {
            grp_Filter2D_fu_48_ap_start_reg = ap_const_logic_0;
        }
    }
    if ((!(esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(p_src_cols_V_empty_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(p_src_rows_V_empty_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
        p_src_cols_V_read_reg_77 = p_src_cols_V_dout.read();
        p_src_rows_V_read_reg_72 = p_src_rows_V_dout.read();
    }
}
...
void Sobel_1::thread_ap_done() {
    if ((esl_seteq<1,1,1>(grp_Filter2D_fu_48_ap_done.read(), ap_const_logic_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
...
void Sobel_1::thread_grp_Filter2D_fu_48_ap_start() {
    grp_Filter2D_fu_48_ap_start = grp_Filter2D_fu_48_ap_start_reg.read();
}

void Sobel_1::thread_p_dst_data_stream_V_din() {
    p_dst_data_stream_V_din = grp_Filter2D_fu_48_p_dst_data_stream_V_din.read();
}

void Sobel_1::thread_p_dst_data_stream_V_write() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        p_dst_data_stream_V_write = grp_Filter2D_fu_48_p_dst_data_stream_V_write.read();
    } else {
...
void Sobel_1::thread_p_src_data_stream_V_read() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        p_src_data_stream_V_read = grp_Filter2D_fu_48_p_src_data_stream_V_read.read();
    } else {
...
void Sobel_1::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(grp_Filter2D_fu_48_ap_done.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
                ap_NS_fsm = ap_ST_fsm_state2;
            }

...
AXIvideo2Mat::AXIvideo2Mat(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, t_V_20_reg_172, "t_V_20_reg_172");
...
void AXIvideo2Mat::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && 
         esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_fu_308_p2.read()))) {
        t_V_20_reg_172 = j_V_fu_313_p2.read();
    } else if ((esl_seteq<1,1,1>(exitcond9_i_fu_297_p2.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()))) {
        t_V_20_reg_172 = ap_const_lv32_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
...
void AXIvideo2Mat::thread_exitcond_i_fu_308_p2() {
    exitcond_i_fu_308_p2 = (!t_V_20_reg_172.read().is_01() || !cols_V_reg_338.read().is_01())? sc_lv<1>(): sc_lv<1>(t_V_20_reg_172.read() == cols_V_reg_338.read());
}
...
void AXIvideo2Mat::thread_j_V_fu_313_p2() {
    j_V_fu_313_p2 = (!t_V_20_reg_172.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(t_V_20_reg_172.read()) + sc_biguint<32>(ap_const_lv32_1));
}

...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_axis_TDATA { O 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_axis_TKEEP { O 2 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_axis_TSTRB { O 2 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_rows_V_dout { I 4 vector } img_rows_V_empty_n { I 1 bit } img_rows_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_cols_V_dout { I 10 vector } img_cols_V_empty_n { I 1 bit } img_cols_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_data_stream_V_dout { I 16 vector } img_data_stream_V_empty_n { I 1 bit } img_data_stream_V_read { O 1 bit } } \
} "
}

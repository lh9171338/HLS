...
#ifndef __HoughCircles_Coreg8j__HH__
#define __HoughCircles_Coreg8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(HoughCircles_Coreg8j) {
    ...
    SC_CTOR(HoughCircles_Coreg8j):  simcore_mac_1_U ("simcore_mac_1_U") {

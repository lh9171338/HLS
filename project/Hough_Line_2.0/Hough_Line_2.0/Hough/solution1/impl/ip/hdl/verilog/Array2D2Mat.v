...
reg   [0:0] tmp_271_i_reg_226;
reg    mat_rows_V_blk_n;
reg    mat_cols_V_blk_n;
reg   [6:0] j_i_reg_140;
reg   [3:0] arr_rows_read_reg_202;
reg    ap_block_state1;
reg   [7:0] arr_cols_read_reg_207;
wire   [9:0] next_mul_fu_151_p2;
reg   [9:0] next_mul_reg_212;
wire    ap_CS_fsm_state2;
wire   [0:0] tmp_i_fu_161_p2;
wire   [2:0] i_fu_166_p2;
reg   [2:0] i_reg_221;
wire   [0:0] tmp_271_i_fu_176_p2;
wire    ap_block_state3_pp0_stage0_iter0;
reg    ap_block_state4_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [6:0] j_fu_181_p2;
...
wire   [63:0] tmp_74_cast_fu_197_p1;
reg    ap_block_pp0_stage0_01001;
wire   [3:0] i_cast_cast_i_fu_157_p1;
wire   [7:0] j_cast_cast_i_fu_172_p1;
wire   [9:0] tmp_272_i_cast_fu_187_p1;
wire   [9:0] tmp_s_fu_191_p2;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (((tmp_i_fu_161_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        j_i_reg_140 <= 7'd0;
    end else if (((tmp_271_i_fu_176_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((tmp_271_i_fu_176_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((tmp_271_i_reg_226 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((tmp_271_i_reg_226 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (tmp_271_i_fu_176_p2 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (tmp_271_i_fu_176_p2 == 1'd0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((tmp_271_i_reg_226 == 1'd1) & (mat_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((tmp_271_i_reg_226 == 1'd1) & (mat_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((tmp_271_i_reg_226 == 1'd1) & (mat_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((tmp_271_i_reg_226 == 1'd1) & (mat_data_stream_V_full_n == 1'b0));
end
...
assign arr_val_address0 = tmp_74_cast_fu_197_p1;

assign i_cast_cast_i_fu_157_p1 = i_i_reg_117;

assign i_fu_166_p2 = (i_i_reg_117 + 3'd1);

assign j_cast_cast_i_fu_172_p1 = j_i_reg_140;

assign j_fu_181_p2 = (j_i_reg_140 + 7'd1);
...
assign next_mul_fu_151_p2 = (phi_mul_reg_128 + 10'd100);

assign start_out = real_start;

assign tmp_271_i_fu_176_p2 = (($signed(j_cast_cast_i_fu_172_p1) < $signed(arr_cols_read_reg_207)) ? 1'b1 : 1'b0);

assign tmp_272_i_cast_fu_187_p1 = j_i_reg_140;

assign tmp_74_cast_fu_197_p1 = tmp_s_fu_191_p2;

assign tmp_i_fu_161_p2 = (($signed(i_cast_cast_i_fu_157_p1) < $signed(arr_rows_read_reg_202)) ? 1'b1 : 1'b0);

assign tmp_s_fu_191_p2 = (phi_mul_reg_128 + tmp_272_i_cast_fu_187_p1);
